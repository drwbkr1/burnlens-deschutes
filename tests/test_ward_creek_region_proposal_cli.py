...
class WardCreekRegionProposalCliTests(unittest.TestCase):
    def _run_with_geo_imports_blocked(
        ...
        script = textwrap.dedent(
            ...
            from burnlens.inspect_ward_creek_region_proposal import main
    ...
    def test_help_does_not_require_geo_research_profile(self) -> None:
        ...
        self.assertIn("--background-report", completed.stdout)
    ...
    def test_execution_without_geo_profile_fails_with_setup_guidance(self) -> None:
        completed = self._run_with_geo_imports_blocked(
            [
                ...
                "--background-report", "background.json",
                "--sufficiency-report", "sufficiency.json",
                "--output-directory", "output",
                "--generated-at-utc", "2026-07-24T00:00:00Z",
                "--run-id", "test-run",
                "--git-source-commit", "0" * 40,
            ]
        )
