...
- Current request checkpoint: candidate BurnLens `0.22.0`; issue #421 / PR #422; parent #416; source `725522bd31616a258fcf399fea2a4839165e2791`; public artifacts `921a271858d7de1469e2d53d96d37c46774c126e`; run `BL-2026-07-17-current-reference-bundle-request-r001`; exact request accepted, delivery pending
...
- Current bundle request: candidate `CURRENT-REFERENCE-BUNDLE-REQUEST-2026-001`; six standard map IDs plus one explicit nonstandard Tepee BAER path; 18 product families; official queue acceptance; four binding provider cautions; zero archives received; recipient and retrieval details withheld
...
- Latest verified repository baseline: `v0.21.1-reference-inventory-checkout-stability` at merge `65ef67a206ebfa697e6047ca09ce26eec6a24dd7`; tag object `1b84f92cf4e7249e524fab095e233192698b7666`; the 0.21.0 analytical tag is preserved but failed final release verification
