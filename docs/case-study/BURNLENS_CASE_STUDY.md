...
- Active release candidate: BurnLens 0.47.0 / P2O4-T35 / issue #534; intake source `68fd2171e52844f717ef0d6a1b108121cd93bee1`; run `BL-2026-07-24-windigo-owner-response-intake-r003`; sole exact response locked before reveal; two yes decisions plus every non-owner gate pass; candidate v0.4 has 12 balanced regions across six events; dataset/split/baseline/model remain null; final HTML owner render, U06 release, PR, merge, and tag pending
