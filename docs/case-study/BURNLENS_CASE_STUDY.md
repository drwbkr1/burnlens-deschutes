...
- Current release candidate: BurnLens `0.29.0`; issue #453; generator `407981e1f98570bb8bd7695951d6cc5d67dab042`; artifacts `0e5306c6d94c54b47df40486a75e5bbd69bab62f`; run `BL-2026-07-18-region-candidate-pilot-r006`; six intact candidates / 136 core pixels / 246 unknown-ring pixels / zero region responses / zero labels
...
- Verified `v0.27.0-prototype-label-sufficiency` proves the 24 sparse owner-approved center pixels are insufficient. Verified `v0.28.0-label-region-remediation-plan` defines contiguous-region review and six-event/source-regime gates. The `0.29.0` candidate executes six no-promotion regions on actual evidence; it is not review completion, a dataset, or training.
