...
The highest remaining risk is still burn-scar label truth across events. BurnLens has accepted ten balanced owner-approved prototype regions across Darlene, McKay, Tepee, Green Ridge, and Grandview, but five complete events remain below the six-event minimum and do not establish independent truth. Verified `v0.45.0-petes-lake-material-defer` preserves Petes Lake as the first complete milestone under `checkpoint-policy-v0.1.0` and ends in a controlled material defer: optical and MTBS evidence pass their bounded gates, but final NWI source-project custody remains incomplete after a terminal HTTP-500 response at asset eight. BurnLens does not turn partial custody into labels. No dataset can open until either a newly registered official Petes fallback or an alternate event completes the route and the full sufficiency evaluator passes.
...
- Current verified release: `v0.45.0-petes-lake-material-defer`; issue #521 / PR #527 plus BL-EXC-001 issue #528 / PR #529; lifecycle issue #530 / PR #531; reviewed exception head `9cc07d1767c9912b18c459794dc541417b2b13d2`; checkpoint `d65c24f59ce0c854ba230aa977eaf718d881d952`; tag object `0b466402cdc36b0eacfff97d29dd16fe2a88868a`; corrected 801,906-byte wheel / SHA-256 `8e17c18a53b7770b6de00b9668d02efa9b07945329672ed29883798442d906ea`; runtime/dev/geo/custody/replay/package/tag gates pass; Petes remains deferred and is not event six
- Current release candidate: BurnLens `0.46.0`; issue #532; run `BL-2026-07-23-official-fallback-closeout-r001`; exact McKenzie/Milli comparison selects neither; report JSON `ff5b326f...`, HTML `8855b8bc...`, PNG `0b7ef00f...`; owner-confirmed desktop/narrow render; zero provider bytes, custody mutation, candidates, labels, data, or model advancement; PR/merge/tag pending
