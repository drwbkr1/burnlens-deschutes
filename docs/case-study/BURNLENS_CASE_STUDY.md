...
- Active release candidate: BurnLens 0.47.0 / P2O4-T35 / issue #534; intake source `68fd2171e52844f717ef0d6a1b108121cd93bee1`; candidate checkpoint `714273adfcf8f90ab16abe798eb086201577b0e9`; run `BL-2026-07-24-windigo-owner-response-intake-r003`; sole exact response locked before reveal; two yes decisions plus every non-owner gate pass; candidate v0.4 has 12 balanced regions across six events; dataset/split/baseline/model remain null; owner-confirmed render, 575 tests, reproducible package, isolated install, and claim/privacy audits pass; PR, merge, fresh-main verification, and tag pending
