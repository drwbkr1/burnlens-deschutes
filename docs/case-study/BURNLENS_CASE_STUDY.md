...
The highest remaining risk is still burn-scar label truth across events. BurnLens has now accepted ten balanced owner-approved prototype regions across Darlene, McKay, Tepee, Green Ridge, and Grandview, but five complete events remain below the six-event minimum and do not establish independent truth. Under `checkpoint-policy-v0.1.0`, issue #521 is designated for the first six-event Petes Lake milestone: its source, terms, custody, optical/reference/background, proposal, owner-response, quality, uncertainty, and leakage units may accumulate in one branch while retaining independent immutable records and failures. No dataset can open until that complete route and the separate sufficiency evaluator pass.
...
R002 validates the fix and safely promotes seven ordered assets: complete Wetlands metadata/count/ID/geometry/post-check evidence plus Data Source layer metadata. The next single-attempt Data Source pre-count POST fails before a response object opens, retaining a durable dispatch receipt and an exact zero-byte partial while leaving four later assets untouched. The code had discarded the underlying open exception, so BurnLens does not guess whether the cause was HTTP, timeout, DNS/TLS/socket, provider, request, or local network. U05R2 now requires a privacy-safe controlled failure category and one final wholly disjoint full r003 reacquisition. The seven r002 payloads remain failure evidence and cannot seed fitness. This is reliability evidence—not completed custody, wetland fitness, reference truth, a candidate, or a sixth accepted event.
...
- Current verified release: `v0.44.0-grandview-owner-response-intake`; issue #517 / PR #522; lifecycle issue #523 / PR #524; checkpoint `5e1d5a05dbb09e8ac42be5928b2d042a0737336e`; tag object `e4f834cd3c55d44895766695a40746fa224df9bd`; lock `6a75065fb1e339d7c26208329ee080129de58803`; intake `33e5b02bebf335c5026688a3d2a33ae2d48b8991`; run `BL-2026-07-21-grandview-owner-response-intake-r002`; ten balanced prototype regions across five events; exact render, reconstruction, tests, package, isolated-install, and remote-tag gates pass; the v0.44 sequence stopped before #521 pending BL-GOV-003
