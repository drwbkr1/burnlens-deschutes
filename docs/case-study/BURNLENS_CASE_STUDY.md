...
- Current verified release: `v0.39.0-grandview-source-fitness`; current release candidate: `v0.40.0-grandview-reference-fitness`; issue #499; generator `9f28f822c114788a1a9bb09a52fab22616be0376`; exact 22,076,790-byte Grandview delivery; 20 native reference rasters; 58,438 MTBS class 2-4 pixels; RAVG sparse-cover limitation enforced; exact reconstruction, 316 tests, rendering, privacy, and canonical packaging pass; no new candidate or label; next #503
