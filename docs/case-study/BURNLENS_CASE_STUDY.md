...
- Current release candidate: BurnLens `0.32.0`; issue #466; generator `1d80ef5788ded4eb0f736120fb9023cc1919ea41`; run `BL-2026-07-19-additional-event-groups-r002`; Green Ridge, Grandview, and Petes Lake frozen at metadata level; 6.277 GiB catalogued and zero provider bytes downloaded
