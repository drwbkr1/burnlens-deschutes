...
The highest remaining risk is still burn-scar label truth across events. BurnLens has now accepted ten balanced owner-approved prototype regions across Darlene, McKay, Tepee, Green Ridge, and Grandview, but five complete events remain below the six-event minimum and do not establish independent truth. Petes Lake is frozen as the next whole-event group. No dataset can open until its exact source pixels, both classes, unknown coverage, owner review, dominance, transfer, and leakage-resistant separation are validated and the separate sufficiency evaluator passes.
...
One burned and one background region pass, adding 50 core pixels / 2.00 ha while all 98 ring pixels remain unknown and excluded. Candidate label set `owner-approved-prototype-region-labels-v0.3.0` is balanced at five regions per class, 236 core pixels / 9.44 ha, and 431 excluded ring pixels across five complete events. That is better prototype evidence, not independent ground truth, a dataset, a split, a baseline, a model, or field validation. Petes Lake is the sixth-event gate under issue #521, and even a pass there must return to the full sufficiency evaluator before training can begin.
...
- Candidate Grandview owner-response intake run: `BL-2026-07-21-grandview-owner-response-intake-r002`
...
- Current verified release: `v0.43.0-grandview-owner-review-surface`; issue #511 / PR #518; lifecycle #519 / PR #520; checkpoint `aeea6f5cc488ae975badbdf654d0164570db77c4`; tag object `d679521edcc1d5b1bfd3e8022036cae06a9f1978`; generator `91ba39ceb4b6d8444255d734eb7a6cc393f933af`; artifacts `33c7c871dcdb2546cf3fd8fe97e01e109cee8026`; run `BL-2026-07-21-grandview-owner-review-surface-r001`; blank two-candidate yes/no/uncertain surface; fresh-main tests, exact artifacts, canonical packaging, and tag verification pass; zero owner responses or labels
- Active release candidate: `v0.44.0-grandview-owner-response-intake`; issue #517; lock `6a75065fb1e339d7c26208329ee080129de58803`; intake `33e5b02bebf335c5026688a3d2a33ae2d48b8991`; run `BL-2026-07-21-grandview-owner-response-intake-r002`; ten balanced prototype regions across five events; owner-confirmed local HTML render and all pre-merge gates pass; repository publication pending
