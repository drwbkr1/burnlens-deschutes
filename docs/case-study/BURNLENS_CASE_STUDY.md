...
The highest remaining risk is still burn-scar label truth across events. BurnLens has identified and visually validated Darlene, McKay, and Tepee evidence, passed separate registration and proposal QA, and accepted six owner-approved prototype regions. It has now frozen three more exact event/scene/geography/time acquisition groups from current official metadata. Those groups close the six-event planning minimum but do not become a dataset until their exact source pixels, both classes, unknown coverage, owner review, dominance, and whole-group separation are validated.
...
- Latest verified tool: BurnLens `0.31.0`; issue #461 / PR #463; remediation #464 / PR #465; checkpoint `70dca180d851fadc9ae3b7a897bdf55cf698b3c3`; run `BL-2026-07-19-region-owner-response-intake-r001`; tag object `3ead929db9129da8da836373a177f2e5ba87c89b`; six owner-approved prototype regions across three events; dataset absent
- Current verified release: `v0.32.0-additional-event-groups`; checkpoint `25fa2b5ecef05e7a5fba87cd3c634ffb3951be90`; tag object `d97aadd4aef60b55ce8c4200fed4eaf58f28dc73`; Green Ridge, Grandview, and Petes Lake frozen at metadata level; 6.277 GiB catalogued and zero provider bytes downloaded; issue #472 owns Green Ridge acquisition
- Current candidate: BurnLens 0.33.0; issue #472; exact Green Ridge optical pair registered; 44,110 native boundary pixels; 99.9887% pair eligible; nine of nine registration windows pass; official reference pixels and labels remain absent
...
- Latest verified repository baseline: `v0.31.0-region-owner-response-intake` at checkpoint `70dca180d851fadc9ae3b7a897bdf55cf698b3c3`; tag object `3ead929db9129da8da836373a177f2e5ba87c89b`; issue #461 / PR #463; remediation #464 / PR #465; lifecycle #467 / PR #468; next #466
...
- Verified `v0.27.0-prototype-label-sufficiency` proves the 24 sparse owner-approved center pixels are insufficient. Verified `v0.28.0-label-region-remediation-plan` defines contiguous-region review and six-event/source-regime gates. Verified `v0.29.0-region-candidate-pilot` executes six no-promotion regions on actual evidence; issue #457 owns their exact owner-review surface. This is not review completion, a dataset, or training.
