...
5. **Submission QA and package — active:** assemble one deterministic August 6 submission bundle from verified v0.48, add concise reviewer instructions and an inventory, then verify exact extraction, links, privacy, claims, and offline opening with remediation time.
