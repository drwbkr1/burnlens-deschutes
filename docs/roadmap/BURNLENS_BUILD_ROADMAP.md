...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; single-reviewer reconciliation authorized; dataset not created** | P2O4-T10A / issue #407 / PR #408 ships exact owner-waiver reveal readiness with zero reveal actions. Issue #403 now controls conservative private reconciliation. Inter-rater validation and adjudication remain absent; accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T10A ship proposal, cross-event, review, handoff, custody, atomic-intake, and owner-waiver reveal readiness through verified `0.19.0`. The owner explicitly waived reviewer two; #393 is superseded and #403 controls single-reviewer reconciliation with permanently reduced validation. The reveal remains operator-declared unopened until that run records access, and an accepted dataset, split, baseline, model, or deployed analytical application does not exist.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T10A ships verified owner-waiver reveal readiness. Issue #403 is the current scientific checkpoint and may open the exact reveal only inside deterministic private reconciliation. Preserve disagreement/uncertainty as ignored. Keep all whole-event groups and ignore states binding; do not begin dataset-candidacy or partition work early.
