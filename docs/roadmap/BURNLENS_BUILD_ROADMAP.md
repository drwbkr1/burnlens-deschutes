...
| 6 | Portfolio publication, public release, communication, and closeout | Publish one coherent, traceable portfolio release whose demo, case study, repository, presentation, licensing, citation, archive, and maintenance posture all refer to the same accepted evidence and limitations. | **active — P6O1-T01 U01-U04 passed; U05 remediation active** | Issue #578 starts from exact lifecycle merge `3097ac5...`. U05 r001 is retained because its source commit cannot pass locked fresh-environment setup; a no-overwrite v0.1.1 / r002 correction from a lock-consistent clean commit is next. U06-U07 remain before any publication action. | [Phase Six objectives](../phases/phase-06/PHASE_06_OBJECTIVES.md) |
