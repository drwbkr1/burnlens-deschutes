...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; source scout candidate; delivery, owner review, product fitness, and dataset not complete** | P2O4-T12A preserves the accepted seven-product request and four provider cautions while reporting zero archives received; #416 owns exact delivery/fitness. P2O4-T13 ranks 21 additional candidates across seven source classes. The owner-confirmed route must reopen all 56 units and requires source/reproducibility/quality/leakage gates after any yes. Accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T12A ship proposal, cross-event, review, custody, historical single-response reconciliation, current catalog, and verified accepted-request evidence through `v0.22.0-current-bundle-request-evidence`. Candidate P2O4-T13 adds live official-source roles and 21 additional event candidates without acquiring large products or duplicating the pending request. The historical single-response result remains 6 burned / 0 background / 50 ignored, but all 56 units will be reconsidered under disclosed owner yes/no/uncertain. Exact delivery and product fitness remain under #416. No owner-approved prototype label, accepted dataset, split, baseline, model, or deployed analytical application exists.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T10B is immutable historical reconciliation, not the current acceptance route. P2O4-T12A preserves an accepted exact request without confusing it with delivery. P2O4-T13 maps additional official evidence and events without substituting for that request. Issue #416 owns exact current bundle terms, bytes, structure, and pixel fitness. The owner-confirmed route reopens all 56 units; yes still requires reproducibility/source/quality/leakage gates, while no/uncertain remain excluded. Preserve whole-event groups and ignore states, strengthen both binary classes, and do not begin partition or baseline work early.
