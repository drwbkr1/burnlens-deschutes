...
**Current status:** P2O1-T02 through P2O3-T01 ship the exact route/access, AOI, source/reference, target, optical-pair, and pair-local registration evidence. P2O4-T01 through P2O4-T04 ship native-grid and cross-event five-state proposal evidence, all-pixel QA, source fitness, and topology-stable provenance. P2O4-T05 / issue #375 / PR #376 ships verified `0.13.0`: exact real-source reconstruction precedes deterministic selection of 56 proposal-blinded review units, and separate integrity QA records zero human responses/adjudications. P2O4-T06 / issue #379 / PR #380 ships verified `0.14.0`: it isolates the reviewer bundle, supplies an offline response workbench, independently verifies it, and locks returned responses before reveal. P2O4-T07 / issue #383 / PR #385 ships verified `0.15.0` and proves the exact current-Chrome interaction path with an explicitly non-human fixture. P2O4-T08 / issue #384 has a `0.16.0` candidate that verifies one exact private returned response and receipt while publishing only content-withheld cryptographic and completeness evidence. The reveal remains operator-declared unopened, a second response and adjudication are still required, and an accepted dataset, split, baseline, model, or deployed analytical application does not exist.

**Gate outcome:** the owner selected the burn-scar fallback; Darlene, Tepee, and McKay proposal/QA evidence exists with uncertainty and groups preserved; the review instrument, isolated handoff, and exact current-Chrome software path are shipped. One returned response is preserved and locked before reveal, and its bounded public receipt is a release candidate. Complete its repository release gates, then obtain and lock the required second qualifying response, adjudicate disagreements or keep units ignored, and make a dataset-candidacy, remediation, or baseline-only deferral decision. Do not create a split, baseline, or model until the label evidence and group-overlap gates pass.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T07 / issue #383 / PR #385 is shipped at verified `v0.15.0-live-browser-reviewer-handoff`. P2O4-T08 / issue #384 has a BurnLens `0.16.0` candidate public receipt for one exact response preserved and operator-locked without opening the reveal. Complete its PR/merge/tag/fresh-main gates, then obtain and lock the required second qualifying response before comparing or adjudicating disagreements. Keep all whole-event groups and ignore states binding; do not begin dataset-candidacy or partition work early.
