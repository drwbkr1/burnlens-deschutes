...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; reviewer-two gate owner-waived; single-reviewer reconciliation required; dataset not created** | P2O4-T09B / issue #402 / PR #404 ships a fixture-only atomic preservation path. The owner closed #393 as superseded and issue #403 now controls a conservative single-reviewer reveal/reconciliation route. Inter-rater validation and adjudication remain absent; accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship the exact route/access, AOI, source/reference, target, optical-pair, and pair-local registration evidence. P2O4-T01 through P2O4-T04 ship native-grid and cross-event five-state proposal evidence, all-pixel QA, source fitness, and topology-stable provenance. P2O4-T05 through P2O4-T07 ship the proposal-blinded review instrument, isolated handoff, and exact browser acceptance path. P2O4-T08 ships verified `0.16.0` first-response hash-lock evidence. P2O4-T09A / issue #394 / PR #395 ships verified `0.17.0` mixed-version two-lock custody readiness with one real response and one software fixture. P2O4-T09B / issue #402 / PR #404 ships verified `0.18.0` atomic preservation readiness exercised only with the software fixture. The owner explicitly waived reviewer two; #393 is superseded and #403 controls a single-reviewer reveal/reconciliation route with permanently reduced validation. The reveal remains operator-declared unopened, and an accepted dataset, split, baseline, model, or deployed analytical application does not exist.

**Gate outcome:** the owner selected the burn-scar fallback; Darlene, Tepee, and McKay proposal/QA evidence exists with uncertainty and groups preserved; the review instrument, isolated handoff, exact current-Chrome software path, first returned-response hash lock, and custody-readiness paths are shipped or in candidate review. The owner waived reviewer two. Next publish owner-waiver/reveal readiness, reconcile the single independent response against proposal and source evidence, retain every unresolved or weakly supported unit as ignored, and make a dataset-candidacy, remediation, baseline-only, or stop decision. Do not create a split, baseline, or model until those label-evidence and group-overlap gates pass.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T09B ships verified `v0.18.0-atomic-response-intake-readiness` through issue #402 / PR #404. The owner-authorized [single-reviewer path](../phase-two/objective-four/SINGLE_REVIEWER_PATH_DECISION.md) closes #393 as superseded and activates #403. The next scientific checkpoint must audit the waiver, authorize reveal separately, reconcile one independent response conservatively, and preserve disagreement/uncertainty as ignored. Keep all whole-event groups and ignore states binding; do not begin dataset-candidacy or partition work early.
