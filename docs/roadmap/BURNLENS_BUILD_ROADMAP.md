...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; owner review surface verified; owner response and dataset not complete** | Verified P2O4-T14 reopens all 56 units with disclosed optical/current-reference evidence and exact yes/no/uncertain custody. Issue #437 owns the actual response. A yes still requires source/reproducibility/quality/leakage gates; 32 nonbinary-origin units remain quality-blocked. Accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T14 ship proposal, cross-event, review, custody, historical single-response reconciliation, current catalog/request, source-scout, verified exact-bundle fitness, and the verified 56-unit owner surface. Issue #437 owns actual owner-response intake. Restricted thresholded Tepee BARC remains private and excluded. No owner-approved prototype label, accepted dataset, split, baseline, model, or deployed analytical application exists.
