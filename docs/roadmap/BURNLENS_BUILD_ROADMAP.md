...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O1-T01 through P2O2-T02 are shipped and tagged through `v0.3.0-intake-transaction-baseline` at `ee1a1d678ad888b595dc3c7b215f787ea5156582`; `aoi-darlene3-model-v0.2.0` remains frozen for modeling. `ACCESS-2026-006` clears the owner-authorization gate. After lifecycle sync issue #327 ships, the highest-leverage checkpoint is exact paired asset quarantine, validation, real-file inspection, and accept/reject evidence on a new issue-backed branch. Transaction, geometry, and metadata coverage remain integrity/scope evidence, never a detection.
