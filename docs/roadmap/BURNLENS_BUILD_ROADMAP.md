...
**Gate outcome:** the owner selected the burn-scar fallback; the exact pair/protocol gate and pair-local translation prerequisite pass. Proceed only to a reviewable five-state label proposal and independent QA. That label gate must pass before considering a dataset, baseline, or later model work.
