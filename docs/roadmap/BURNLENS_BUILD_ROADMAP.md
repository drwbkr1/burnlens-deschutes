...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; burn-scar fallback approved; labels and dataset not created** | P2O2-T04 rejects direct active-fire label promotion on real temporal/scale evidence. P2O2-T05 / #337 / PR #338 activates `target-burn-scar-v0.2.0`; #339 / PR #340 corrects its caught post-merge determinism defect before tagging. A pre/post optical source-and-protocol gate remains next. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** Objectives One through Six are complete as documentation/control baselines. P1O7-T08 / PR #294 accepted the evidence for Phase Two planning only. PR #291 and `v0.0.8-execution-goal-baseline` version that control baseline. No analytical release exists. Phase Two metadata, route, access-integrity, final-AOI, intake-transaction, authenticated source/reference inspection, and complete observation-geometry evidence are shipped through P2O2-T04 / `v0.5.0-observation-geometry-baseline`. P2O2-T05 / #337 / PR #338 merged the owner-approved burn-scar target path without analytical output; #339 holds the release tag until corrected reconstruction passes after merge. Authorized credentials were exercised without committing raw source bytes or secret material.
...
**Current status:** P2O1-T02 / issue #312 narrows the discovery set to one exact Sentinel-2 L2A product and the closest same-day NOAA-21 VIIRS active-fire/geolocation pair. P2O1-T03 / issue #317 proves that unauthenticated LP DAAC responses are Earthdata Login HTML rather than source assets. P2O2-T01 / issue #321 / PR #322 ships `aoi-darlene3-model-v0.2.0`, a deterministic 12 km by 9 km modeling boundary derived from one public NIFC final-perimeter reference, at `v0.2.0-aoi-baseline`. P2O2-T02 / issue #325 / PR #326 ships the three-asset registration boundary at `v0.3.0-intake-transaction-baseline`. P2O2-T03 / issue #329 / PR #330 registers the exact 1.17 GB source package and opens the real Sentinel/VIIRS arrays at `v0.4.0-authenticated-source-baseline`. P2O2-T04 / issue #333 then inspects the complete 23-granule bounded inventory and exact selected companion. The day candidate improves median view zenith to 31.01 degrees with no residual-bowtie exclusions, but its 2.48-hour time offset and 375 m support reject direct labels. P2O2-T05 / issue #337 / PR #338 records the owner's activation of the burn-scar binary-mask fallback. Issue #339 preserves the merged `r001` evidence and publishes corrected LF-stable `r002` evidence before tagging. Current official MTBS 2024 and all-years occurrence layers expose no Darlene 3 feature in the frozen AOI, so MTBS cannot supply an exact label today. No label, dataset, baseline, or model exists.

**Gate outcome:** the owner selected the documented burn-scar fallback. Proceed only to a pre/post optical source and binary label-protocol gate; then decide whether label construction, a non-model baseline, a dataset, and later model work are defensible.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O2-T04 / issue #333 / PR #334 shipped at `1c85496d9d488c0d2d5a58207d8b4786a683ba52` and is tagged `v0.5.0-observation-geometry-baseline`; lifecycle sync issue #335 / PR #336 is merged. `aoi-darlene3-model-v0.2.0` remains frozen. P2O2-T05 / issue #337 / PR #338 merged at `68971e9709b886adf8575a58d32694aad42f038e`; issue #339 / PR #340 is the bounded pre-tag determinism remediation and publishes immutable corrected run `TARGET-DECISION-2026-002`. After PR #340 passes post-merge reconstruction and the tag is verified, the next checkpoint must visually validate one legally usable pre/post optical source pair and define an uncertainty-preserving burn-scar label protocol before any label or dataset build.
