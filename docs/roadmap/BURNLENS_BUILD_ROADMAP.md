...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; owner review surface in PR #434; owner response and dataset not complete** | Candidate P2O4-T14 reopens all 56 units with disclosed optical/current-reference evidence and exact yes/no/uncertain custody. A yes still requires source/reproducibility/quality/leakage gates; 32 nonbinary-origin units remain quality-blocked. Accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T13 ship proposal, cross-event, review, custody, historical single-response reconciliation, current catalog/request, source-scout, and verified exact-bundle fitness evidence. Candidate P2O4-T14 / PR #434 reopens all 56 units under disclosed owner yes/no/uncertain without inheriting historical exclusions. Restricted thresholded Tepee BARC remains private and excluded. No owner-approved prototype label, accepted dataset, split, baseline, model, or deployed analytical application exists.

**Gate outcome:** the owner selected the burn-scar fallback; Darlene, Tepee, and McKay proposal/QA evidence exists with uncertainty and groups preserved; the review instrument, exact current-Chrome software path, response custody, historical reconciliation, and current cross-program bundle evidence are executable. P2O4-T14 now supplies the prospective owner surface but records zero owner answers. Do not create a split, baseline, or model until an exact owner response and owner-label, source, reproducibility, quality, leakage, and group-overlap gates pass.
