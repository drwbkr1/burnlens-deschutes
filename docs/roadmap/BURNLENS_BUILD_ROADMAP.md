...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; current reference evidence under checkout-stability remediation; product fitness and dataset not created** | P2O4-T11 confirms seven exact current catalog records across all events and closes label promotion; issue #417 owns the 0.21.1 release repair and issue #416 owns exact bundle fitness. Inter-rater validation, consensus, adjudication, accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T10B ship proposal, cross-event, review, handoff, custody, atomic-intake, owner-waiver readiness, and reduced-validation reconciliation through verified `v0.20.0-single-reviewer-reconciliation`. P2O4-T11 adds current cross-program catalog evidence; 0.21.0 release verification failed on checkout-dependent JSON/HTML bytes and issue #417 carries the 0.21.1 repair. One blinded response still yields 6 burned candidate units, 0 background units, 50 ignored units, and no Tepee candidate. Catalog availability passes, but exact product-bundle fitness is pending under issue #416. An accepted dataset, split, baseline, model, or deployed analytical application does not exist.
