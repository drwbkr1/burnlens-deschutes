...
1. **Open one bounded official-fallback checkpoint:** Register the official McKenzie HUC8 `17090004` package or a better alternate event under fresh source, terms, custody, scientific-fitness, privacy, and failure-retention gates. Begin with metadata/direct-download proof before any acquisition. Do not create r004 or seed from r001-r003, and stop if raw-use licensing or terms remain unresolved.
