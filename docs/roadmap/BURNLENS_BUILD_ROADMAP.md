...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; verified review readiness shipped; isolated offline handoff candidate built; dataset not created** | P2O4-T05 ships the exact 56-unit instrument at verified `v0.13.0`; P2O4-T06 / issue #379 is the `0.14.0` isolated workbench, independent handoff-QA, and response-lock candidate. Independent responses/adjudication, accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T05 is shipped at verified `v0.13.0-label-review-readiness`; P2O4-T06 / issue #379 is the active BurnLens `0.14.0` candidate. Ship and verify the isolated offline handoff, then deliver it to qualifying independent reviewers, preserve returned pre-reveal hashes, adjudicate disagreements or keep units ignored, and decide whether the three-event proposal supports dataset candidacy or requires remediation/baseline-only deferral. Keep all whole-event groups and ignore states binding.
