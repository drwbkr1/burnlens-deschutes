...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; exact bundle fitness verified; owner review and dataset not complete** | Verified P2O4-T12 passes exact delivery, terms, structure, and bounded BAER/RAVG/MTBS fitness; restricted Tepee BARC is excluded. Issue #432 must reopen all 56 units and requires source/reproducibility/quality/leakage gates after any yes. Accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T13 ship proposal, cross-event, review, custody, historical single-response reconciliation, current catalog/request, source-scout, and verified exact-bundle fitness evidence. Restricted thresholded Tepee BARC remains private and excluded. The historical single-response result remains 6 burned / 0 background / 50 ignored, but issue #432 will reconsider all 56 units under disclosed owner yes/no/uncertain. No owner-approved prototype label, accepted dataset, split, baseline, model, or deployed analytical application exists.
