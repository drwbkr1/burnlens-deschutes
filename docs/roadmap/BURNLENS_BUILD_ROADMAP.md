...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; Petes Lake U04 next** | Verified Green Ridge plus verified P2O4-T32 Grandview intake establish five complete prototype-label events. Issue #521 is active; U01/U02 pass, U03 r001 remains a planned-post failure, and replacement U03 passes exact custody, native-pixel quality, registration, and real rendering with explicit spatial exclusions. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Gate outcome:** Green Ridge and Grandview have passed their complete optical/reference/background/proposal/review/intake paths. Verified v0.44 includes owner-confirmed local HTML rendering, exact fresh-main reconstruction, canonical packaging, isolated installation, and remote-tag verification. Under `checkpoint-policy-v0.1.0`, issue #521 groups the complete Petes Lake source, terms, custody, optical/reference/background, proposal, owner-response, quality, uncertainty, and leakage evidence while retaining each unit independently. U01/U02 pass; U03 r001 retains the planned snow-dominated failure. The exact 19 October replacement now passes replacement-specific terms, singleton custody, native CRS/grid/nodata/SCL/CLD/SNW inspection, 97.8360% paired eligibility, five passing registration windows, three spatial exclusions, zero failed windows, and original-resolution rendering. U04 reference inspection is next. Passing the eventual milestone still does not authorize a dataset: Objective Five's separate class/unknown completeness, source-regime replication, never-tuned transfer, dominance, leakage, baseline, and split gates remain authoritative.
