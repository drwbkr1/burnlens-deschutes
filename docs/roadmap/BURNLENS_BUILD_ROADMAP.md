...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T06 is shipped at verified `v0.14.0-offline-reviewer-handoff`; P2O4-T07 / issue #383 is the active live-browser QA candidate. One exact returned response is preserved and operator-locked under issue #384 without opening the reveal. Next ship its sanitized public receipt, obtain and lock the required second qualifying response, then compare and adjudicate disagreements or keep units ignored before any dataset-candidacy or partition decision. Keep all whole-event groups and ignore states binding.
