...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; verified isolated offline reviewer handoff shipped; dataset not created** | P2O4-T05 ships the exact 56-unit instrument at verified `v0.13.0`; P2O4-T06 / issue #379 / PR #380 ships the `v0.14.0` isolated workbench, independent handoff QA, and response lock. Independent responses/adjudication, accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
