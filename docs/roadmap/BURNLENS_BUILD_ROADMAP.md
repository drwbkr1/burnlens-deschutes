...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; exact bundle fitness candidate passes; owner review and dataset not complete** | P2O4-T12 now verifies exact delivery, terms, structure, and bounded BAER/RAVG/MTBS fitness under #416; restricted Tepee BARC is excluded. Verified P2O4-T13 ranks 21 additional candidates. The owner-confirmed route must reopen all 56 units and requires source/reproducibility/quality/leakage gates after any yes. Accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. P2O4-T01 through P2O4-T13 ship proposal, cross-event, review, custody, historical single-response reconciliation, current catalog/request, and official-source-scout evidence. The P2O4-T12 candidate now verifies exact delivery and bounded fitness for seven current BAER/RAVG/MTBS products; restricted thresholded Tepee BARC remains private and excluded. The historical single-response result remains 6 burned / 0 background / 50 ignored, but all 56 units will be reconsidered under disclosed owner yes/no/uncertain. No owner-approved prototype label, accepted dataset, split, baseline, model, or deployed analytical application exists.

**Gate outcome:** the owner selected the burn-scar fallback; Darlene, Tepee, and McKay proposal/QA evidence exists with uncertainty and groups preserved; the review instrument, isolated handoff, exact current-Chrome software path, response custody, waiver authorization, single-reviewer reconciliation, and current cross-program bundle evidence are executable. The reconciliation chooses remediation, not dataset candidacy. Issue #416's exact-delivery/fitness gate now passes as bounded owner-review evidence; its next checkpoint must reopen all 56 units and retain weak/conflicting evidence as no/uncertain or otherwise excluded. Do not create a split, baseline, or model until owner-label, source, reproducibility, quality, leakage, and group-overlap gates pass.
