...
| 2 | Data acquisition, labels, baselines, and dataset versioning | Build a complete, traceable data foundation for one bounded Deschutes County experiment, including authorized sources and AOI, reproducible preprocessing, defensible positive/negative/unknown labels, leakage-resistant splits, non-model baselines, dataset QA, and a model-readiness decision. | **active - incomplete; reconciliation chooses remediation; dataset not created** | P2O4-T10B / issue #403 retains 6 burned candidate units, 0 background units, and 50 ignored units. Issue #411 now owns cross-event reference-evidence remediation. Inter-rater validation, consensus, adjudication, accepted labels, splits, baselines, dataset QA, and model-readiness remain open. | [Phase Two objectives](../phases/phase-02/PHASE_02_OBJECTIVES.md) |
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T10B / issue #403 records the reduced-validation reconciliation and defers the dataset. Issue #411 is the next scientific checkpoint. Preserve disagreement/uncertainty as ignored, strengthen both binary classes across all events, keep whole-event groups and ignore states binding, and do not begin partition or baseline work early.
