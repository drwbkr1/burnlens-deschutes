...
1. **Active six-event evidence milestone — issue #521:** U01/U02 pass. U03 r001 rejects the planned post scene because local snow leaves zero passing windows; research and contract a same-event replacement post before continuing the Petes Lake reference/background/proposal/owner chain. Each unit and remediation run retains independent immutable records and failures.
