...
**Gate outcome:** 24 prototype points pass owner-response gates but fail dataset sufficiency. P2O4-T16 defines evidence-coherent native-grid regions, one-pixel unknown rings, exact owner review, and at least six whole-event groups with replicated source regimes. Implement and render a small region-candidate pilot before acquisition; preserve natural prevalence and never-tuned transfer events before repeating dataset and split gates.
