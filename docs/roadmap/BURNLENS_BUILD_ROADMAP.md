...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T04 / issue #367 is the verified BurnLens `0.12.0` candidate. Next, create bounded independent label-fitness/adjudication evidence and decide whether the three-event proposal supports dataset candidacy or requires remediation/baseline-only deferral. Keep all whole-event groups and ignore states binding.
