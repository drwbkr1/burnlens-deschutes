...
**Gate outcome:** 24 prototype points pass owner-response gates but fail dataset sufficiency. Do not tile or expand them. Create reviewed contiguous burned/background/unknown regions, add event/source-regime diversity, preserve natural prevalence, and reserve independent evaluation evidence before repeating dataset and split gates.
