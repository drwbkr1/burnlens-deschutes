...
**Gate outcome:** Twenty-four prototype points remain audit evidence. P2O4-T19 now accepts six evidence-coherent owner-approved prototype regions: three burned, three background, 136 core pixels, and 246 excluded unknown-ring pixels across three whole events. At least six whole-event groups with replicated source regimes remain required; add comparable events only through separately gated work before repeating dataset and split gates.
...
The controlling execution goal remains `v0.0.8-execution-goal-baseline` at `22a8d88435cb8d5b900a398b7482c3b7277d2ee6`. P2O4-T10B is immutable historical reconciliation, not the current acceptance route. P2O4-T19 preserves the exact completed region response and accepts six prototype regions only after all gates pass. Preserve whole-event groups and ignore states, acquire and gate at least three additional comparable events with replicated source regimes, and do not create a dataset or baseline until a new fitness gate passes.
