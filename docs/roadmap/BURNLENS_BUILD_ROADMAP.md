...
**Current status:** P2O1-T02 through P2O3-T01 ship exact route/access, AOI, source/reference, target, optical-pair, and registration evidence. Twenty-four original owner-approved prototype points remain immutable audit evidence. Verified P2O4-T19 through P2O4-T32 establish ten balanced regions across five events. P2O4-T33 preserves Petes Lake's material defer, and P2O4-T34 defers McKenzie and Milli. Verified P2O4-T35 accepts Windigo only after exact source-pixel, two-class, owner-custody, uncertainty, leakage, render, corrected-main, package, and release gates pass. `owner-approved-prototype-region-labels-v0.4.0` contains 12 balanced regions, 286 core pixels / 11.44 ha, and 533 excluded unknown-ring pixels across six events. Verified BurnLens 0.50.0 / P2O5-T02 reconstructs every region and tests all 90 whole-event 2/2/2 assignments. Leakage/split fitness and evaluation design block because Darlene is the sole NIFC-context event. P2O4-T39 / issue #554 owns exactly one replicated-regime replacement event and a full rerun. Ward Creek U01-U05 pass exact source, custody, fitness, terms, raster, quality, registration, route, proposal, replay, render, and package gates. U05 proposes one intact 14-pixel burned core and one intact 25-pixel affirmative-background core plus 66 excluded ring pixels. U06 exact two-card review replays six outputs and passes real desktop/narrow, export/lock software QA, fixed-epoch package, and isolated 97-command runtime gates. One unambiguous 1,041-byte owner response is now preserved in ignored no-overwrite custody at SHA-256 `aadd221d...`; decisions and notes remain unread. U06 is `pass-decisions-unrevealed`, and U07 is blocked pending reconciliation and every non-owner gate. Restricted thresholded Tepee BARC remains private and unused. Prototype v0.4 is unchanged. No accepted dataset, split, baseline, model, or deployed analytical application exists.
