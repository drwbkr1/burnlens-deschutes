...
| Report/interface | `target-path-decision-v0.2.0`; semantic HTML and PNG expose the target decision, active-fire disposition, current MTBS result, next gate, warning, run ID, source commit, and null app/dataset/label/baseline/model versions |
