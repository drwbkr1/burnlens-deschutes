...
|---|---|---|---|
| `v0.3.0-intake-transaction-baseline` | Candidate; tag not created | Report-generator source `41f86dec62f0a5e8cd159c75932999790ab0f840`; issue #325 / PR #326; checkpoint commit pending | Exact three-asset and transaction-invariant contract, link-alias rejection, fail-closed validation, local multihash registration, retry-safe atomic promotion, and deterministic real-state/synthetic-rehearsal evidence with non-inflating metadata time. Zero credentials, provider assets/bytes, promoted real packages, or retained synthetic bytes. |
...
| Paired-intake transaction | BurnLens package `0.3.0`; `paired-intake-contract-v0.3.0`; full contract SHA-256 `3fb736b4af757260f90affd4b5c0b902a44b0b9e3036158d34b7e5563b0809da`; report-generator source `41f86dec62f0a5e8cd159c75932999790ab0f840`; 36 repository tests passing |
| Paired-intake rehearsal | `PAIR-INTAKE-REHEARSAL-2026-001`; JSON `e6a137eaf8a96a9a5a1362d6564aa3690691ea1b8b1a107a4873f1b173ad2970`; HTML `1be709541ebc23c8ee128dacca3ae63e978ccfd8f2b62eed9516f653bfe4b444`; PNG `4a3462c766b030277a8d6bf16ce435d39eebaf95a6a4fe6163c63118c494be88`; real decision `BLOCKED_OWNER_CREDENTIAL` |
| Dataset | Not created |
