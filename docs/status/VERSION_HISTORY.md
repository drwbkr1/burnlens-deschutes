...
|---|---|---|---|
| `v0.7.0-optical-pair-protocol-baseline` | Candidate; create only after merged-main reconstruction | Pending | Exact same-orbit Sentinel-2A pair, real AOI pixel evidence, safe promotion-failure handling, and unimplemented `burn-scar-label-protocol-v0.1.0`, issue #343. Two raw assets / 2,254,805,631 bytes remain local and ignored; zero label, dataset, baseline, model, or raw provider bytes committed. |
