...
| Asset-readiness record set | `SOURCE-2026-004` through `SOURCE-2026-006`; exact assets registered in ignored local raw storage and shipped as source/reference evidence at `v0.4.0-authenticated-source-baseline`; zero raw provider bytes committed |
