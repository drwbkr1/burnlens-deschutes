...
|---|---|---|---|
| `v0.3.0-intake-transaction-baseline` | Candidate; tag not created | Report-generator source `8f1f82f97afc4fb52f787c6353a9aedd0f36cea3`; issue #325 / PR #326; checkpoint commit pending | Exact three-asset and transaction-invariant contract, link-alias rejection, fail-closed validation, local multihash registration, atomic all-or-none promotion, and deterministic real-state/synthetic-rehearsal evidence with non-inflating metadata time. Zero credentials, provider assets/bytes, promoted real packages, or retained synthetic bytes. |
...
| Paired-intake transaction | BurnLens package `0.3.0`; `paired-intake-contract-v0.2.0`; full contract SHA-256 `0bc075bb6cf912e27a6bba6f1c79b10456c9915d0eb20669a9e48e1b9f56d93a`; report-generator source `8f1f82f97afc4fb52f787c6353a9aedd0f36cea3`; 35 repository tests passing |
| Paired-intake rehearsal | `PAIR-INTAKE-REHEARSAL-2026-001`; JSON `c2bed364223184e176b8b58fa366f97df5143b5d3c59bafadacebcaa504f08da`; HTML `d47a912d1326743b2a2da64cabeda8321d319ecf81578ae5aea1d4ead797b33c`; PNG `06d32c6cac853fe3c9c7eea3e042c8612467959536a26a8cfddc64dfde492f1a`; real decision `BLOCKED_OWNER_CREDENTIAL` |
| Dataset | Not created |
