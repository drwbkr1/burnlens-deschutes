...
The source-metadata and asset-readiness baselines record availability, route, and governance evidence only. They do not imply that any scene contains a Darlene 3 detection, that provider source assets have been accessed, or that the active-fire target is label-ready.
