...
|---|---|---|---|
| `v0.3.0-intake-transaction-baseline` | Candidate; tag not created | Report-generator source `5cd157aaf0a5b372d2052acd7c19fda6b9fbef8f`; issue #325 / PR #326; checkpoint commit pending | Exact three-asset contract, fail-closed validation, local multihash registration, atomic all-or-none promotion, and deterministic real-state/synthetic-rehearsal evidence with non-inflating metadata time. Zero credentials, provider assets/bytes, promoted real packages, or retained synthetic bytes. |
...
| Paired-intake transaction | BurnLens package `0.3.0`; `paired-intake-contract-v0.1.0`; contract SHA-256 `85b6934ed3fe47dabfdddd47375dc07fc78bd0db8d15c24cb3a50c53e65b8362`; report-generator source `5cd157aaf0a5b372d2052acd7c19fda6b9fbef8f`; 32 repository tests passing |
| Paired-intake rehearsal | `PAIR-INTAKE-REHEARSAL-2026-001`; JSON `7293b8523d4193d0511426ac06e83353f3b33921b0059ebe3c38fa7f093e8a0b`; HTML `767c59ab0a9c4c01968b27169cfcf3157c634cc930a00d8c732720ee74674f14`; PNG `c35a30384bc1098b361b9cb5ce1036b193b87edf6a9bf7054b40d74ffcbead4c`; real decision `BLOCKED_OWNER_CREDENTIAL` |
| Dataset | Not created |
