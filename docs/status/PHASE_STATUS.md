...
| Evidence tooling | Shipped BurnLens `0.13.0` supplies the exact packet. Shipped `0.14.0` adds deterministic isolated handoff building, an independent archive/interface verifier, exact response export, and fail-closed response locking |
...
| Run IDs | Latest shipped runs are handoff `BL-2026-07-16-label-review-handoff-r001` and handoff QA `BL-2026-07-16-label-review-handoff-qa-r001`; no accepted dataset, split, baseline, model, or inference output |
