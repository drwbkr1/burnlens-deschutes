...
| 2 — Data foundation | Legally usable, versioned, leakage-resistant data/label/baseline package with model-readiness decision | **Active; verified proposal-blinded review readiness shipped; dataset not created** | P2O4-T05 / issue #375 / PR #376 ships a 56-unit, three-event review instrument and integrity QA after exact proposal reconstruction at verified v0.13.0. Independent responses/adjudication, accepted labels, a split, baselines, and model-readiness remain open. |
...
|---|---|
| Latest repository evidence baseline | Shipped `v0.13.0-label-review-readiness` at merge `67dc6023859ba3ec9ce6bb375ae001ff962639c6`; tag object `2f4db3e24e1a9bcb82ab56026b13e833004ef453`; reviewed head `119b1e98f7928bb1c2f09d577bfa270d903766c7`; source `a11ae5123728d3823ba67d22d49250d4affb18f6`; artifacts `f15cc0608e2093daf0ca339c17145d50933cc743`; 56 review units / 14 present strata / one structural absence; completed responses/adjudications zero |
| Previous repository evidence baseline | Shipped `v0.12.1-topology-stable-label-transfer` at merge `e00028509145b439d95eb302591e7cb19bd073fd`; tag object `8606c61f0e1668f2b057abca177144937eae1036`; generator/QA source `0c2b489f34915e352cefe72ca76dea488bc8a4db`; analytical v0.12.0 package preserved |
...
| Evidence tooling | Shipped BurnLens `0.13.0` adds exact three-proposal reconstruction, deterministic event/state review sampling, proposal-blinded/reveal-separated rendering, blank response/adjudication schemas, and independently implemented packet/response QA |
...
| Run IDs | Latest shipped evidence runs are review packet `BL-2026-07-16-label-review-packet-r001` and integrity QA `BL-2026-07-16-label-review-packet-qa-r001`; no accepted dataset, split, baseline, model, or inference output |
...
P2O4-T05 / issue #375 / PR #376 ships `v0.13.0-label-review-readiness` at merge `67dc6023859ba3ec9ce6bb375ae001ff962639c6`. A detached fresh merged-main checkout passes 144 tests, exact 18-output manifest/LF/raw gates, compilation, dependency health, 21 declared entry points, the canonical fixed-epoch source wheel, fresh real-source 18-of-18 reconstruction, and remote annotated-tag verification. Tag object `2f4db3e24e1a9bcb82ab56026b13e833004ef453` peels to that merge. Lifecycle synchronization is issue #377.

## Current checkpoint

P2O4-T05 / issue #375 / PR #376 is shipped at verified `v0.13.0-label-review-readiness`. It makes independent review executable without claiming it has occurred. Completed independent responses and adjudications remain zero. The next bounded checkpoint is to obtain qualifying reviewer responses, preserve their pre-reveal hashes, adjudicate disagreements or keep those units ignored, and make an explicit dataset-candidacy or remediation decision. No split creation is authorized yet.
