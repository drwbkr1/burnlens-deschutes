...
|---|---|
| Latest repository evidence baseline | `55c70d076c97f5d2727bdd0d91f39be0f9bac1d3` via issue #353 / PR #354 and verified annotated `v0.9.0-label-proposal-baseline`; tag object `5a95b4d39710fc81a1193a83ad41a766cba61834` |
...
| Cross-event feasibility candidate | BurnLens `0.10.0`; issue #357; generator/assessor `ea3e164d09872825a0fadc64b9492e30c85c83c8`; `CROSS-EVENT-SOURCE-2026-001` and `CROSS-EVENT-FITNESS-2026-001`; Tepee and McKay selected, Milli tile-seam exclusion; whole groups frozen before acquisition; PR/merge/tag pending; provider imagery, dataset, and split absent |
...
| Evidence tooling | BurnLens `0.9.0` remains the latest shipped baseline; the `0.10.0` working candidate adds current cross-event metadata capture, exact scene pairing, group freeze, tile-seam exclusion, and deterministic JSON/HTML/PNG rendering |
...
| Run IDs | Latest candidate runs are `RUN-2026-07-15-CROSS-EVENT-SOURCE-001` and `RUN-2026-07-15-CROSS-EVENT-FITNESS-001`; no accepted dataset, split, baseline, model, or inference output |
...
P2O4-T01 remains the latest shipped baseline. P2O4-T02 / issue #357 is accepted as a working analytical candidate: `CROSS-EVENT-FITNESS-2026-001` selects exact Tepee/McKay acquisition pairs, excludes Milli because no one tile covers its full boundary, and freezes whole event/scene/geography/time groups. Shipment still requires PR, merged-main reconstruction, packaging, and tag verification. After shipment, acquire and validate only the four frozen products before cross-event label or split work.
...
No application or deployed public companion site exists in this repository yet. The repository README, living case study, and static semantic/visual evidence reports, including the proposal/QA and cross-event feasibility render, are the presentation surfaces for this checkpoint.
