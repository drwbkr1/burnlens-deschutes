...
The transaction baseline shipped through issue #325 / PR #326 at `ee1a1d678ad888b595dc3c7b215f787ea5156582` and annotated tag `v0.3.0-intake-transaction-baseline`. P2O2-T03 / issue #329 subsequently fulfilled this gate: the authorized exact package passed the contract, entered excluded raw storage atomically, and received a separate pixel-, quality-, geolocation-, and target-fitness decision in `AUTHENTICATED_SOURCE_INSPECTION_DECISION.md`. That later decision accepts source/reference use and defers labels and a dataset.
