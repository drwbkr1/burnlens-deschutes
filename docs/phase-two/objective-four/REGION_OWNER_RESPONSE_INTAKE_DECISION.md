...
**Verified checkpoint / tag:** `70dca180d851fadc9ae3b7a897bdf55cf698b3c3` / `v0.31.0-region-owner-response-intake` (annotated object `3ead929db9129da8da836373a177f2e5ba87c89b`)
...
The first merged-main reconstruction withheld release because Markdown record line endings changed JSON byte bindings. Issue #464 / PR #465 preserves the exact mixed historical EOL identities. A separate fresh remote-main clone then reconstructs all three public outputs exactly; 254 tests and the canonical package pass. Issue #466 owns the next bounded additional-event checkpoint.
