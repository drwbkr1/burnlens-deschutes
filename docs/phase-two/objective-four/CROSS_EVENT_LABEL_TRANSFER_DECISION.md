...
PR #372 shipped at squash merge `e00028509145b439d95eb302591e7cb19bd073fd` from reviewed head `345dd72363377aad3215d23a8120c42edbe85278`. A fresh merged-main clone passes every release gate and reconstructs all ten outputs. Verified annotated tag object `8606c61f0e1668f2b057abca177144937eae1036` remotely peels to the exact merge as `v0.12.1-topology-stable-label-transfer`.
