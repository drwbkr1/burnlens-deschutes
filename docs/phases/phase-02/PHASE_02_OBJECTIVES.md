...
P2O1-T01 through P2O1-T03 establish the public metadata, exact route, terms, and delivery-integrity baseline. P2O2-T01 through P2O2-T06 ship the final AOI, exact source transactions, real source/observation evidence, active burn-scar target, and same-orbit optical pair/protocol. P2O3-T01 ships verified pair-local registration. P2O4-T01 through P2O4-T12A ship proposal, cross-event, review, handoff, custody, atomic-intake, owner-waiver reveal readiness, reduced-validation reconciliation, current cross-program catalog, and accepted-request evidence through verified `v0.22.0-current-bundle-request-evidence`. Exact current bundle delivery and fitness remain under issue #416. The reconciled counts remain 6 burned candidates, 0 background candidates, and 50 ignored. No inter-rater validation, consensus, adjudicated label set, accepted dataset, split, baseline, model, or deployed analytical application exists.
