...
P2O1-T01 through P2O1-T03 establish the public metadata, exact route, terms, and delivery-integrity baseline. P2O2-T01 through P2O2-T06 ship the final AOI, exact source transactions, real source/observation evidence, active burn-scar target, and same-orbit optical pair/protocol. P2O3-T01 ships verified pair-local registration. P2O4-T01 through P2O4-T10A ship proposal, cross-event, review, handoff, custody, atomic-intake, and owner-waiver reveal readiness through verified `v0.19.0-owner-waiver-reveal-readiness`. P2O4-T10B / issue #403 is the `0.20.0` candidate: it opens and reconciles the exact reveal and one blinded response, retains 6 burned units as candidate evidence, retains 50 as ignored, and finds no candidate background or Tepee unit. It therefore chooses remediation and defers the dataset. No inter-rater validation, consensus, adjudicated label set, accepted dataset, split, baseline, model, or deployed analytical application exists.
