...
**Active after verified v0.46 - P2O4-T35 U01-U05 accept Windigo as the sixth candidate prototype event; 12 balanced regions; separate sufficiency evaluator and dataset remain closed.**

P2O1-T01 through P2O3-T01 establish metadata, route, terms, AOI, source transactions, source/observation evidence, the active burn-scar target, exact optical pairs, and verified registration. The historical point-review path preserves 24 explicitly owner-approved prototype points as audit evidence; its prior 6 burned / 0 background / 50 ignored result is not inherited. Verified P2O4-T19 through P2O4-T32 produce ten balanced regions across five events. P2O4-T33 ships verified BurnLens 0.45.0 without changing that set. P2O4-T34 / issue #532 / PR #533 ships verified BurnLens 0.46.0, defers McKenzie and Milli, and selects neither. P2O4-T35 / issue #534 executes only Windigo before the August 6 portfolio deadline. U01-U05 pass the exact source, custody, fitness, proposal, pre-reveal owner lock, and two-class promotion chain. Candidate `owner-approved-prototype-region-labels-v0.4.0` contains 12 balanced regions, 286 core pixels / 11.44 ha, and 533 excluded unknown-ring pixels across six events. No GitHub Release, deployment, accepted dataset, split, baseline, model, or deployed analytical application exists.

Current objective posture: Objectives One and Two retain the accepted controlled source stack. Objective Three preserves immutable preprocessing and proposal rasters. Objective Four has executed the region-first, explicit-unknown, owner yes/no/uncertain, exact-response-custody, aggregate-only publication, and no-partial-promotion contract across six candidate complete events. Under `checkpoint-policy-v0.1.0`, Petes Lake remains a terminal material defer, and McKenzie and Milli remain unselected. Windigo passes with one region per class only after exact source-pixel and owner-custody gates. Objective Five's executable sufficiency gate stays closed: the six-event count is necessary but class/unknown completeness, source-regime replication, never-tuned transfer, event dominance, leakage, baseline, and split checks have not re-passed. Objective Six remains open. This ordering is evidence-responsive, not checklist completion.
