...
**Active - verified cross-event five-state proposal and separate software QA shipped; dataset not created.**

P2O1-T01 through P2O1-T03 establish the public metadata, exact route, terms, and delivery-integrity baseline. P2O2-T01 through P2O2-T06 ship the final AOI, exact source transactions, real source/observation evidence, active burn-scar target, and same-orbit optical pair/protocol. P2O3-T01 ships verified pair-local registration. P2O4-T01 ships verified `v0.9.0-label-proposal-baseline` and implements `burn-scar-five-state-schema-v0.1.0`. P2O4-T02 freezes exact Tepee/McKay pairs and groups. P2O4-T03 proves exact source fitness. P2O4-T04 / issue #367 / PR #368 ships verified `v0.12.0-cross-event-label-transfer-baseline`: Tepee/McKay proposals preserve five states and separate QA reproduces all 63,930 pixels with zero mismatch. Reviewable three-event proposal evidence exists; no independently reviewed label set, accepted dataset, split, baseline, or model exists.
