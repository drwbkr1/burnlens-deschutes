...
Issue #363 closed through PR #364 at merge `01c3aa4abeb89e3f15771571276a25d33e44d390`. A second fresh no-hardlink merged-main clone passes 129 tests, compilation, dependency health, exact output/manifest/semantic/LF/link/raw/secret gates, original-resolution review, live browser review, wheel build, and isolated import. Annotated tag object `eca7ba5362518684f2a1e25d5abdbc1707e24a61` remotely peels to that merge as verified `v0.11.0-cross-event-source-fitness-baseline`. The next checkpoint is cross-event five-state proposal transfer plus separate QA with Tepee exclusions binding; split construction remains deferred.
