...
PR #388 reviewed head `7a1345d187def41094ccb9d63d44958a3de809e7` merged to `836eef75495dbc671bd74a8ad4112852bbf50ac6`. The post-merge audit correctly withheld the tag after finding that the candidate manifest's stated creation time was later than both its own commit and the merge. Issue #389 / PR #390 corrected only that chronology at merge `27fcd3eadb1473bb603b4275f986bf62022c10bf`; no private byte, public output, code path, or scientific state changed. Fresh corrected-main gates passed, and annotated tag object `da94fc97efc07b07d9520022fdbff42a85e8ba00` remotely peels to the corrected merge as `v0.16.0-first-reviewer-response-lock`.
