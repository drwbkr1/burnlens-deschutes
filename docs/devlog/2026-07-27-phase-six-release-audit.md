...
Final 0.56.0 wheels match at SHA-256 `3efc07da...`; a fresh Python 3.12.10
...
checksum-corrected head passes 801 tests, one expected skip, 422 existing NumPy
...
Risk-bearing commit `bc9646c...` then passes 802 tests, one expected skip, 422
existing warnings, and 86 subtests. Its two 1,228,670-byte wheels match at
`3efc07da...`; the corrected outside-source import resolves only to isolated
`site-packages`, and all 122 installed commands pass.
