...
Issue #347 / PR #348 merged the analytical candidate at `c01cdb12033e7a9440ad0502b92a8887fd79ed1d`. Generator source `5287704a37f03d96e47467afba8623f7be643129` produces JSON `f0682f51bebe93d970774748c23317d8759bae4b7e34478fb6659d9606b28645`, HTML `b8ed29f1f18acc75275e0cbef0fd6d0b1d6764ef2737d1f5e53bb45d5fcd407f`, and PNG `70ba55e6a15f2b712bd167e8d3d0736daf19284bae0f3f0f721a07a3e1c017f1`. Post-merge Windows checkout reproduced the PNG but exposed CRLF JSON/HTML against the declared LF contract, so the release tag was withheld. Remediation issue #349 adds explicit registration-artifact LF attributes and regression coverage. A fresh clone at remediation source `d2c90f47e473d74638300856a3b3150aa169e579` checks both text artifacts out with LF, reconstructs all three hashes byte for byte, and passes 94 tests. Exact remediation PR/merge, final clean-main verification, and annotated-tag identities remain pending.
