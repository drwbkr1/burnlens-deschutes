...
Candidate head `dbedb98c847b28c59d3997ee364b0d35c317e3c4` passes all 330 tests in two complete bounded shards, compilation, 111 JSON parses, controller syntax, and all six exact artifact checks. Two fixed-epoch 613,569-byte wheels are byte-identical at SHA-256 `dc96dd1d3805b6d58ed8e3f2a615e22bcc93e885fb06326de758a39d7b3675f5`; the clean wheel contains 141 entries and 68 commands. An isolated dependency-complete install imports BurnLens 0.43.0 from `site-packages`, starts the new CLI, and reports no broken requirements. PR #518 is open; remote-head, merged-main, and remote-tag gates remain pending.
