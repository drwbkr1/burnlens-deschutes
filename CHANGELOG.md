...
- Produce the corrected 801,911-byte wheel / SHA-256 `055e56b1...` with 170 exact entries, 81 unchanged commands, and complete RECORD coverage from two clean builds at `77d32c5...` plus one fresh no-hardlink build at `5e55ec8...`.
