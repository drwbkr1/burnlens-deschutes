...
PR #518 reviewed head `248f601485c813d7dd2f629195ead75eb325465f` squash-merges at checkpoint `aeea6f5cc488ae975badbdf654d0164570db77c4`. A new remote-main clone passes 313 tests with 17 expected custody skips, compilation, 111 JSON parses, zero surface JSON/HTML CRLF, all six exact artifact hashes, and two canonical wheels. Annotated tag object `d679521edcc1d5b1bfd3e8022036cae06a9f1978` remotely peels to the checkpoint. Lifecycle issue #519 records the release; issue #517 remains blocked on a later completed owner export.
