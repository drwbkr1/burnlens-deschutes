...
1. Open `BURNLENS-PORTFOLIO-REVIEWER-EXPERIENCE-2026-002.html`.
...
- No model, weights, training run, model evaluation, inference, or
  model-to-GEOINT application exists.
...
model-readiness, and Petes Lake retained-failure inputs before writing. It
refuses changed inputs and existing outputs.
