...
if (-not $Quarantine) {
    $Quarantine = Join-Path $repoRoot 'downloads\phase-two\quarantine\burnlens-cross-event-optical-package-v0.1.0'
}
if (-not $RawParent) {
...
try {
    ...
    & $PythonExecutable -m burnlens.acquire_cross_event_optical `
