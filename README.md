...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; Phase Two metadata, access, AOI, intake-transaction, source inspection, observation geometry, target-decision, and optical-pair protocol evidence are shipped through `v0.7.0-optical-pair-protocol-baseline`.
