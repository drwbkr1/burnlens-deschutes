...
The project has shipped, verified Phase Two burn-scar target-decision, real-pixel optical-pair protocol, and pair-local content-registration baselines. It is not an analytical release.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; shipped Phase Two evidence now runs through verified `v0.8.0-content-registration-baseline`.
...
- The latest verified repository evidence baseline is remediation merge `1297471be45200c40f9f40746e85b437ce6e0c0d` from issue #349 / PR #350; annotated tag object `14edfad3ce89dbd9179a54eb1e29811e41d258c0` remotely dereferences to that exact commit as `v0.8.0-content-registration-baseline`.
