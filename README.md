...
The latest verified release is `v0.46.0-official-fallback-source-gate-defer`. It compares the McKenzie HUC8 `17090004` NWI route with Milli 0843 CS and selects neither. PR #533 merged reviewed head `2e9436e5f30a7810c11313f5731ed07e39e712a0` through `0e58459ea45f509eca537223d872fd6992efb291`; annotated tag object `ec2aad7a706c591b23fc0b6c16891ba6be706e95` remotely peels exactly to that merge.

P2O4-T35 / issue #534 / PR #535 is merged at `00d01402657e92357f5f4c795ba9a4f4fd99038a`. The exact Windigo response was locked before reveal and is the sole valid final. Both owner decisions are yes. Final r003 recomputes the exact Sentinel and BAER/MTBS/RAVG source pixels, both proposal routes, candidate rasters, registration, terms, uncertainty, and leakage gates. [Open the aggregate intake report](samples/labels/review/windigo/phase-two/intake/WINDIGO-OWNER-RESPONSE-INTAKE-2026-001.html) or [read the decision](docs/phase-two/objective-four/WINDIGO_OWNER_RESPONSE_INTAKE_DECISION.md). Candidate `owner-approved-prototype-region-labels-v0.4.0` is balanced at 12 regions, 286 core pixels / 11.44 ha, and 533 excluded unknown-ring pixels across six complete events. It is not ground truth or a dataset. Fresh-main verification correctly withheld the tag after Windows checkout changed exact bound-record bytes. BL-EXC-002 / issue #536 is the active checkout-byte remediation; scientific and public artifact Git blobs remain unchanged.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.46.0-official-fallback-source-gate-defer`. Tag object `ec2aad7a706c591b23fc0b6c16891ba6be706e95` remotely peels to checkpoint `0e58459ea45f509eca537223d872fd6992efb291`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T35 / issue #534 freezes the August 6 critical path. U01-U05 pass the exact Windigo source, custody, fitness, proposal, owner-custody, and two-class promotion gates. U06 candidate checks pass owner-confirmed rendering, the 575-test suite, reproducible packaging, isolated installation, and public-claim/privacy audits. Candidate BurnLens 0.47.0 accepts Windigo as event six while keeping dataset, split, baseline, and model versions null; shipment remains pending.
