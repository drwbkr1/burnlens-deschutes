...
The latest verified release is `v0.37.0-green-ridge-owner-review-surface`. BurnLens 0.38.0 is the issue-#491 release candidate: one exact response is operator-locked, both Green Ridge decisions are yes, and both regions pass every non-owner gate. The cumulative prototype set is balanced at eight regions across four events; dataset, split, baseline, and model work remains blocked below six events.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.37.0-green-ridge-owner-review-surface`. Tag object `f6976b709c902957273d57308b5acaef371d027c` remotely peels to checkpoint `16504c810d60dcaba74297db077e481b682228e7`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T26 / issue #491 is the BurnLens 0.38.0 release candidate. [Open the Green Ridge aggregate intake report](samples/labels/review/green-ridge/phase-two/intake/GREEN-RIDGE-OWNER-RESPONSE-INTAKE-2026-001.html) or [read the decision](docs/phase-two/objective-four/GREEN_RIDGE_OWNER_RESPONSE_INTAKE_DECISION.md). Both exact owner-approved regions pass every gate; the cumulative set is four burned and four background regions across four events, while dataset fitness remains blocked. Issue #495 owns Grandview source fitness.
