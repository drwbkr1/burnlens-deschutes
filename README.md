...
The latest verified repository release remains `v0.50.0-six-event-dataset-sufficiency` until the coherent P2O4-T39 milestone merges and its v0.51 tag is verified. The 0.51.0 candidate binds accepted analytical run `BL-2026-07-25-replacement-six-event-dataset-sufficiency-r003` to source `af37f80dd17febacfbb1cf2801665d74edb16475`. It contains McKay, Tepee, Green Ridge, Grandview, Windigo, and Ward Creek, excludes Darlene, preserves 531 unknown-ring exclusions, and keeps `training_authorized` false. Release-code candidate `064da9a...` passes 656 tests, exact six-output replay, real desktop/narrow rendering, two byte-identical 993,480-byte wheels, and a fresh isolated 99-command lean runtime. [Draft PR #557](https://github.com/drwbkr1/burnlens-deschutes/pull/557) is clean and mergeable; merge, fresh-main, and annotated-tag verification remain pending.
