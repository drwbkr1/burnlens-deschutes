...
- P2O2-T05 / issue #337 / PR #338 merged at `68971e9709b886adf8575a58d32694aad42f038e` and records the owner's decision to activate the controlled burn-scar binary-mask fallback as `target-burn-scar-v0.2.0`. Post-merge verification caught checkout-dependent hashing before release; issue #339 / PR #340 corrects that reliability defect in `TARGET-DECISION-2026-002` while preserving run `001` as historical evidence. Neither run creates a label, dataset, baseline, or model.
