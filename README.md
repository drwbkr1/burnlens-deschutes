...
The latest verified release is `v0.38.0-green-ridge-owner-response-intake`. One exact response is operator-locked, both Green Ridge decisions are yes, and both regions pass every non-owner gate. The cumulative prototype set is balanced at eight regions across four events; dataset, split, baseline, and model work remains blocked below six events.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.38.0-green-ridge-owner-response-intake`. Tag object `16f364aac604958d812fb2567dd9cd8b5ea13d6c` remotely peels to checkpoint `17bd3652fbb07c096f478224a4d5c173729954c2`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
