...
Issue #508 is the BurnLens 0.42.0 release candidate. It applies the established intact-component protocol to the verified Grandview routes and publishes one 25-pixel proposed burned core and one 25-pixel proposed background core with 98 total unknown-ring pixels. Both remain unreviewed; issue #511 owns a separately versioned blank owner surface.
