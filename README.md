...
The latest verified release is `v0.35.0-green-ridge-background-evidence`. BurnLens 0.36.0 is the issue-#483 release candidate: it deterministically proposes one 25-pixel burned core and one 25-pixel background core with 87 explicit unknown-ring pixels. It creates zero owner responses or labels; issue #487 owns the blank review surface.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.35.0-green-ridge-background-evidence`. Tag object `d901ea55d683a103bf6f00b8fac55434b65518b4` remotely peels to checkpoint `b57bcbe5665dcb09a7e716e2e1de4147be4741e4`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T24 / issue #483 is the BurnLens 0.36.0 release candidate. [Open the Green Ridge region proposal](samples/labels/pilot/green-ridge/phase-two/GREEN-RIDGE-REGION-PROPOSAL-2026-001.html) or [read the decision](docs/phase-two/objective-four/GREEN_RIDGE_REGION_PROPOSAL_DECISION.md). Two exact unreviewed regions and unknown rings are published with zero promotion; issue #487 owns owner review.
