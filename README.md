...
The latest verified Phase Two baseline is P2O4-T12A: the official route accepted the exact seven-product request, while delivery, bundle terms/structure, and pixel fitness remain pending under #416. Candidate P2O4-T13 now adds reproducible official-source reconnaissance without duplicating that request: seven source classes, 23 current Deschutes MTBS fires, and 21 additional candidate fires. GW Fire ranks first for a later small Landsat/cross-program fitness proof, but the advertised Landsat asset route currently requires EROS authentication. The historical 6 burned / 0 background / 50 ignored reconciliation is preserved and unchanged; the owner-confirmed yes/no/uncertain route will reopen all 56 units rather than inherit those exclusions. No owner responses, accepted label set, dataset, split, baseline, model result, or deployed analytical application exists.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.22.0-current-bundle-request-evidence`. Tag object `0407f90c855e0e4b62b37c14ae69c5a85cadcaf7` remotely peels to merge `1bbd3c6385f9a1c543a851a1a278e0ac976a2d57`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
- BL-GOV-002 / issue #400 reconciles obsolete Phase One GitHub backlog against current repository truth. Historical issues, PR bodies, and control artifacts remain audit evidence; they do not represent active work or narrow the controlling execution goal. The [single-reviewer path decision](docs/phase-two/objective-four/SINGLE_REVIEWER_PATH_DECISION.md) and its 6/0/50 result remain historical evidence. The owner-confirmed prototype route now governs prospective labels; issue #425 owns the first official-source scout, and a later bounded checkpoint will reopen all 56 units. Issue #411 owns the shipped current catalog inventory, issue #421 / PR #422 owns accepted-request evidence, and parent #416 owns exact delivery and bundle fitness.
...
| 2 | One legally usable, versioned, leakage-resistant data/label/baseline foundation can support a defensible model-or-stop decision. | Active; exact proposal/QA evidence, a review instrument, custody history, current cross-program inventory, and an accepted exact bundle request exist. Delivery and product fitness remain pending. The historical 6/0/50 reconciliation is preserved, while the owner-confirmed route will reopen all 56 units with yes/no/uncertain and require source/reproducibility/quality/leakage gates after any yes. The official-source scout adds 21 candidate fires but no data or labels. No independent review, accepted dataset, split, baseline, or model-readiness decision exists. |
