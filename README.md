...
- P2O4-T25 / issue #487 is the unshipped BurnLens 0.37.0 candidate. [Open the Green Ridge owner review surface](samples/labels/review/green-ridge/phase-two/GREEN-RIDGE-OWNER-REVIEW-SURFACE-2026-001.html) or [read the candidate decision](docs/phase-two/objective-four/GREEN_RIDGE_OWNER_REVIEW_SURFACE_DECISION.md). The blank surface reconstructs exactly and records zero responses or labels; real browser interaction remains pending. Issue #491 owns later exact response intake only after release verification.
