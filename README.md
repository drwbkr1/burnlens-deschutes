...
The latest verified release is `v0.36.0-green-ridge-region-proposal`. It deterministically proposes one 25-pixel burned core and one 25-pixel background core with 87 explicit unknown-ring pixels. It creates zero owner responses or labels; issue #487 owns the blank review surface.
