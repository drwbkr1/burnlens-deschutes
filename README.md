...
P2O4-T35 / issue #534 is the active deadline-backed milestone. August 6, 2026 is the portfolio deadline. Windigo 2022 is the only final sixth-event attempt and must complete by July 27 at 6:00 PM America/Indianapolis. U01-U03 pass exact identity, terms, custody, delivery, and actual source fitness. U04 now passes the [exact two-class proposal](samples/labels/pilot/windigo/phase-two/WINDIGO-REGION-PROPOSAL-2026-001.html): one BAER-primary/MTBS-corroborated burned core and one separately evidenced optical-stability background core, each with an explicit unknown ring. Production and replay match across JSON, HTML, PNG, and both candidate rasters. The candidates remain unreviewed and create no labels or accepted sixth event. U05 is eligible only for the exact two-card yes/no/uncertain owner review. Any terminal or incomplete gate activates the technical-case-study-only fallback; baseline-first remains unauthorized without an accepted dataset and split.
...
- P2O4-T35 / issue #534 freezes the August 6 critical path: one Windigo attempt, a July 27 6:00 PM Indianapolis cutoff, and a technical-case-study-only fallback. U01-U03 pass exact source entry, custody, and source fitness. U04 passes an exact burned/background proposal with unknown rings and zero promotion; U05 is eligible for only those two owner decisions while accepted scientific state remains unchanged.
