...
P2O4-T35 / issue #534 is the active deadline-backed milestone. August 6, 2026 is the portfolio deadline. Windigo 2022 is the only final sixth-event attempt and must complete by July 27 at 6:00 PM America/Indianapolis. U01/U02 pass exact identity, terms, optical custody, and one combined BAER/RAVG/MTBS delivery. U03 now passes [actual delivered source fitness](samples/cross-event/phase-two/windigo/WINDIGO-SOURCE-FITNESS-2026-004.html): 21 native reference rasters, 10,601 optical-valid boundary pixels, 9/9 registration windows, and 9,789 optical-valid BAER/MTBS affirmative-agreement pixels. Invalid BAER/RAVG vectors remain unrepaired and excluded; MTBS governs topology. No delivered class is affirmative background truth, so U04 must separately prove exactly one burned and one background proposal. Any terminal or incomplete gate activates the technical-case-study-only fallback; baseline-first remains unauthorized without an accepted dataset and split.
