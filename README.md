...
P2O4-T35 / issue #534 is the active deadline-backed milestone. August 6, 2026 is the portfolio deadline. Windigo 2022 is the only final sixth-event attempt and must complete by July 27 at 6:00 PM America/Indianapolis. U01 passes current official identity, valid provider topology, one exact Sentinel pair, current terms, ignored custody, and one combined BAER/RAVG/MTBS request contract. No provider archive or queue request exists yet. Any terminal or incomplete gate activates the technical-case-study-only fallback; baseline-first remains unauthorized without an accepted dataset and split.
