...
U11R1 retains `9f440999...` as failed candidate evidence because its installed U04 replay stopped before output; correction `fcbaa4c...` repairs descendant trace enforcement without changing the 32,991-byte U04 evidence or material-defer decision. Canonical exact U03/U04 replay and full regression pass, while corrected clean-checkout package/install/replay, PR, true merge, fresh-main, and annotated-tag verification remain pending. The latest verified release therefore remains v0.44.0.
