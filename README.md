...
| 2 | One legally usable, versioned, leakage-resistant data/label/baseline foundation can support a defensible model-or-stop decision. | Active; candidate v0.4 contains 12 balanced prototype regions across Darlene, McKay, Tepee, Green Ridge, Grandview, and Windigo. Six events meet only the count minimum. The separate sufficiency evaluator, accepted dataset, split, baseline, and model-readiness decision remain closed. |
