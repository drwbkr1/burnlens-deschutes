...
The latest verified release remains `v0.33.0-green-ridge-source-fitness`; the v0.34 reference-fitness candidate now gates the exact 20,969,722-byte Green Ridge BAER/MTBS/RAVG delivery. It verifies 20 native rasters and measures 41,642 optical-grid pixels with affirmative agreement from MTBS and RAVG. Affirmative background evidence, candidates, owner review, labels, dataset, split, baseline, model result, accuracy, and a deployed analytical application remain absent until the candidate passes release gates.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.33.0-green-ridge-source-fitness`. Tag object `331d727403075e5dc46b17bbac4f46d9ff8669f7` remotely peels to checkpoint `4145b483fe52e5542b03f6651d373b8e72aaf5bd`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
