...
- P2O4-T35 / issue #534 freezes the August 6 critical path. U01-U05 now pass the exact Windigo source, custody, fitness, proposal, owner-custody, and two-class promotion gates. Candidate BurnLens 0.47.0 accepts Windigo as event six while keeping dataset, split, baseline, and model versions null; U06 release closure remains pending.
