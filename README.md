...
BurnLens is not yet model-bearing portfolio ready. P2O5-T02 / issue #552 reconstructs the six complete prototype events and tests all 90 whole-event 2/2/2 assignments. Eight readiness gate families pass, but leakage/split fitness and evaluation design block because Darlene is the sole NIFC-context event. [Open the sufficiency decision surface](samples/labels/readiness/phase-two/SIX-EVENT-DATASET-SUFFICIENCY-2026-001.html) or [read the decision](docs/phase-two/objective-five/SIX_EVENT_DATASET_SUFFICIENCY_DECISION.md). Dataset, split, baseline, U-Net, evaluation, and model-to-GEOINT integration remain absent.
