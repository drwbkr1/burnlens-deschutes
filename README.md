...
The latest verified release is `v0.46.0-official-fallback-source-gate-defer`. It compares the McKenzie HUC8 `17090004` NWI route with Milli 0843 CS and selects neither. PR #533 merged reviewed head `2e9436e5f30a7810c11313f5731ed07e39e712a0` through `0e58459ea45f509eca537223d872fd6992efb291`; annotated tag object `ec2aad7a706c591b23fc0b6c16891ba6be706e95` remotely peels exactly to that merge. The verified v0.3 prototype label set remains ten balanced regions, 236 core pixels / 9.44 ha, and 431 excluded unknown-ring pixels across five complete events; it is not ground truth or a dataset.

P2O4-T35 / issue #534 is the active deadline-backed milestone. August 6, 2026 is the portfolio deadline. Windigo 2022 is the only final sixth-event attempt and must complete by July 27 at 6:00 PM America/Indianapolis. U01/U02 pass exact identity, terms, optical custody, and one combined BAER/RAVG/MTBS delivery. Corrected U03 r006 now passes [actual delivered source fitness](samples/cross-event/phase-two/windigo/WINDIGO-SOURCE-FITNESS-2026-006.html): 21 native reference rasters, 10,601 optical-valid boundary pixels, 9/9 registration windows, and 9,789 optical-valid BAER/MTBS affirmative-agreement pixels. R004 remains superseded because it named the prior v0.2.0 label set; r005 remains an ignored non-existent-commit trace failure. Invalid BAER/RAVG vectors remain unrepaired and excluded; MTBS governs topology. No delivered class is affirmative background truth, so U04 must separately prove exactly one burned and one background proposal. Any terminal or incomplete gate activates the technical-case-study-only fallback; baseline-first remains unauthorized without an accepted dataset and split.
...
- P2O4-T35 / issue #534 freezes the August 6 critical path: one Windigo attempt, a July 27 6:00 PM Indianapolis cutoff, and a technical-case-study-only fallback. U01/U02 pass exact source entry and optical/reference custody. U03 passes actual source fitness with visible vector exclusions and no background-truth inference; U04 is eligible for the exact two-class proposal while accepted scientific state remains unchanged.
