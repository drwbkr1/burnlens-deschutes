...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified tag remains `v0.19.0-owner-waiver-reveal-readiness` at merge `0ab2b948a4d74c770f6d23042a1d9725642eac42` while the `0.20.0` reconciliation candidate is reviewed.
