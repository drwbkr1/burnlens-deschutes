...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; Phase Two metadata, access, AOI, intake-transaction, and authenticated source/reference evidence are shipped through P2O2-T03 / PR #330. P2O2-T04 / issue #333 is the verified `v0.5.0-observation-geometry-baseline` release candidate.
