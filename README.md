...
The latest verified release baseline is `v0.29.0-region-candidate-pilot`. P2O4-T18 / issue #457 now supplies the candidate `0.30.0` owner yes/no/uncertain surface for those exact six regions, with bound optical/reference evidence, deterministic reconstruction, and zero responses or promoted labels. Its merge, release package, tag, and fresh-main gates remain pending. At least six whole-event groups and replicated source regimes are still required before dataset fitness can reopen. No region label, accepted dataset, split, baseline, model result, accuracy claim, or deployed analytical application exists.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.29.0-region-candidate-pilot`. Tag object `55adb8e376988cc3dc4d6bd662e2a5200b8fe1ed` remotely peels to merge `3d3b0128f1f4e4b4aab8e14fc3fabc089fbd8f0a`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T18 / issue #457 builds the candidate BurnLens `0.30.0` owner-region review surface for the exact six shipped regions. [Open the review surface](samples/labels/review/regions/phase-two/REGION-OWNER-REVIEW-SURFACE-2026-001.html) or [read the decision](docs/phase-two/objective-four/REGION_OWNER_REVIEW_SURFACE_DECISION.md). It records zero responses and labels; merge and release verification remain pending.
