...
The latest verified release is `v0.34.0-green-ridge-reference-fitness`. BurnLens 0.35.0 is the issue-#480 release candidate: it registers one exact 1,193,992,663-byte near-anniversary Sentinel scene, passes nine registration windows, and opens a conjunctive background-evidence route containing 26,126 pixels / 1,045.04 ha. It creates zero candidates or labels; issue #483 owns separate Green Ridge region proposal.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.34.0-green-ridge-reference-fitness`. Tag object `0faed9a847756651ba8d62b7baf475ea72c4229f` remotely peels to checkpoint `085cb61d0f1add3f5261582acdd746e298c86ba6`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T23 / issue #480 is the BurnLens 0.35.0 release candidate. [Open the Green Ridge background-evidence report](samples/cross-event/phase-two/GREEN-RIDGE-BACKGROUND-EVIDENCE-2026-001.html) or [read the decision](docs/phase-two/objective-four/GREEN_RIDGE_BACKGROUND_EVIDENCE_DECISION.md). The multi-signal route passes as evidence for later deterministic proposal; it creates zero candidates, owner responses, or labels. Issue #483 owns the next bounded proposal checkpoint.
