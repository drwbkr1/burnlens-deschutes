...
P2O4-T36 / issue #540 is the BurnLens 0.48.0 release candidate. Its deterministic, offline page connects the verified Windigo result, the retained Petes Lake stop, source roles, limitations, reproduction steps, case study, and exact lineage. Desktop and 390-pixel rendering, keyboard order, nine local links, image loading, clean-console, zero-external-request, and byte-identical replay gates pass. The owner confirmed the exact page renders correctly. Shipment gates remain pending; no deployment or public-sharing change is authorized.

## Verified status

The latest verified release is `v0.47.0-windigo-sixth-prototype-event`. P2O4-T35 / issue #534 / PR #535 first merged at `00d01402657e92357f5f4c795ba9a4f4fd99038a`; fresh Windows main then failed closed on six exact-byte checkout gates and withheld the tag. BL-EXC-002 / issue #536 / PR #537 restores explicit LF checkout contracts without changing scientific or public evidence and merges at corrected checkpoint `6a80ba14d060702d97c5d39f40cf3d6f8122ccc8`. Corrected main passes 577 tests with one expected skip and 86 subtests, reproduces the canonical 872,766-byte wheel / SHA-256 `1fabf5408113dcd238871070a3fbe0105526a845c66eb8f0f48edcb99595aea7`, and installs BurnLens 0.47.0 with all 86 commands. Annotated tag object `31cf93a13b8d7d7f2f4a4730cffe5960d7469cb5` remotely peels exactly to the corrected merge.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.47.0-windigo-sixth-prototype-event`. Tag object `31cf93a13b8d7d7f2f4a4730cffe5960d7469cb5` remotely peels to corrected checkpoint `6a80ba14d060702d97c5d39f40cf3d6f8122ccc8`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T36 / issue #540 builds candidate BurnLens 0.48.0 as one local/offline reviewer path. [Open the candidate page](portfolio/BURNLENS-PORTFOLIO-REVIEWER-EXPERIENCE-2026-001.html) or [read the decision](docs/phase-two/objective-four/PORTFOLIO_REVIEWER_EXPERIENCE_DECISION.md). Its final exact outputs and real rendered QA pass; full release verification, PR, merge, tag, and submission packaging remain pending.
