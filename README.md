...
The latest verified release is `v0.39.0-grandview-source-fitness`. The exact Grandview optical pair passes native-pixel quality and registration without creating a candidate or label. The cumulative prototype set remains balanced at eight regions across four events; dataset, split, baseline, and model work remains blocked below six events.
