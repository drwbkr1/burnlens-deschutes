...
The latest verified release is `v0.37.0-green-ridge-owner-review-surface`. It binds both exact Green Ridge proposals to a blank owner yes/no/uncertain surface with five evidence views per question. Exact reconstruction, fresh-main tests and packaging, remote tag verification, and the owner-operated rendered completion/export path pass; issue #491 owns exact response custody and reconciliation.
