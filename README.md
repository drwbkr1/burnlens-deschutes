...
- P2O3-T01 / issue #347 is review-ready. `CONTENT-REGISTRATION-2026-001` measures twelve fixed native-20m windows with `local-content-registration-v0.1.0`; all pass, with median residual 0.0224 pixel and maximum 0.0361 pixel / about 0.72 m. Registration is accepted for a later label proposal, but labels remain unimplemented.
