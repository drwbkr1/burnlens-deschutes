...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; shipped Phase Two evidence runs through verified `v0.15.0-live-browser-reviewer-handoff`, while P2O4-T08 / issue #384 has a `0.16.0` candidate public receipt for the first returned response.
