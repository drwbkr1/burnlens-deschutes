...
The latest verified release is `v0.36.0-green-ridge-region-proposal`. BurnLens 0.37.0 is an unshipped issue-#487 candidate: it binds both exact proposals to a blank owner yes/no/uncertain surface with five evidence views per question. Exact reconstruction, static rendering, tests, and packaging pass; real desktop/mobile export/reload/lock observation remains a release blocker.
...
- The controlling goal remains versioned at `v0.0.8-execution-goal-baseline`; the latest verified repository tag is `v0.36.0-green-ridge-region-proposal`. Tag object `bc0110afa0c4ccf6e3314d394d544cfde16aaae9` remotely peels to checkpoint `71c3ffedeb2bb54bbeca8e97686c8e37e710e354`. Annotated `v0.21.0-current-reference-inventory` remains preserved as failed-release audit evidence.
...
- P2O4-T25 / issue #487 / draft PR #492 is the unshipped BurnLens 0.37.0 candidate. [Open the Green Ridge owner review surface](samples/labels/review/green-ridge/phase-two/GREEN-RIDGE-OWNER-REVIEW-SURFACE-2026-001.html) or [read the candidate decision](docs/phase-two/objective-four/GREEN_RIDGE_OWNER_REVIEW_SURFACE_DECISION.md). The blank surface reconstructs exactly and records zero responses or labels; real browser interaction remains pending. Issue #491 owns later exact response intake only after release verification.
