...
| 2 | One legally usable, versioned, leakage-resistant data/label/baseline foundation can support a defensible model-or-stop decision. | Active; verified v0.27.0 proves the 24 reviewed points are insufficient for dataset/split use. Issue #449 owns contiguous-region and event/source-regime diversity planning. No independent review, accepted dataset, split, baseline, or model-readiness decision exists. |
