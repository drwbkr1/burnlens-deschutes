...
| Baseline verification | BurnLens 0.51.0 is the active release candidate. Final run `BL-2026-07-25-replacement-six-event-dataset-sufficiency-r003` passes the independent readiness audit and real desktop/narrow rendering. Package, PR, merge, fresh-main, and tag verification remain pending. |
