...
| Active analytical candidate | P2O4-T08 / issue #384 / BurnLens `0.16.0`: exact first response and private receipt preserved; bounded public hash-lock evidence generated. PR, merge, tag, and fresh-main gates remain; a second response is the next scientific gate. |
