...
| Baseline verification | Shipped AOI tag resolves to merged PR #322; candidate transaction has 36 passing tests, byte-identical report reconstruction, and original-resolution rendered review |
