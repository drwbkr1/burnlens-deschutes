...
| Baseline verification | Verified v0.46 remains the repository baseline. BurnLens 0.47.0 is a release candidate that adds exact Windigo response reconciliation and a sixth prototype event. Final HTML owner render, PR, merge, fresh-main package/output, and tag gates remain pending. |
