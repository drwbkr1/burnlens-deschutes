...
| Current phase posture | Phase Two active under `checkpoint-policy-v0.1.0`; verified v0.45 preserves ten balanced prototype regions across five complete events and closes Petes Lake through a material-defer result after terminal r003. P2O4-T34 is the BurnLens 0.46.0 source-gate release candidate and defers both McKenzie and Milli without provider bytes; dataset fitness remains a separate closed gate. |
| Current repository baseline | Latest verified tag is `v0.45.0-petes-lake-material-defer` at merge `d65c24f59ce0c854ba230aa977eaf718d881d952`; annotated tag object `0b466402cdc36b0eacfff97d29dd16fe2a88868a` remotely peels exactly to that merge. P2O4-T33 / issue #521 / PR #527 preserves the scientific and custody decision; BL-EXC-001 / issue #528 / PR #529 supplies the verified runtime contract. |
...
| Baseline verification | Verified v0.45 retains r001-r003 custody evidence, repeats the actual Petes render/native replay, passes lean runtime plus dev and geo-research regression, reproduces the canonical 801,906-byte wheel, and verifies the annotated remote tag from fresh merged main. The 0.46.0 candidate adds a deterministic two-route source gate whose exact HTML passes owner-confirmed desktop/narrow rendering; PR, merge, fresh-main package/output, and tag gates remain pending. |
