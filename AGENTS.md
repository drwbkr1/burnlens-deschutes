...
P2O4-T10B / issue #403 / PR #412 has shipped verified `v0.20.0-single-reviewer-reconciliation`, opening and reconciling one exact blinded response under the explicit reviewer-two waiver. BurnLens retains only six burned units as candidate evidence, retains the other fifty units as ignored, and defers the dataset because zero background units and zero Tepee units survive. One reviewer remains one reviewer. P2O4-T11 / issue #411 / PR #415 produced the current BAER/RAVG/MTBS catalog inventory, but the `v0.21.0-current-reference-inventory` release gate failed because its JSON/HTML checkout bytes were not line-ending-stable. Issue #417 carries the bounded BurnLens `0.21.1` checkout-stability remediation; issue #416 remains the next scientific checkpoint. Do not begin splits, baselines, or models early.
...
P2O4-T01 through P2O4-T04 ship verified one-event and cross-event five-state proposal evidence, source fitness, all-pixel software QA, and topology-stable provenance through `v0.12.1-topology-stable-label-transfer`. P2O4-T05 through P2O4-T10B ship verified review, handoff, custody, atomic-intake, owner-waiver readiness, and reduced-validation reconciliation through `v0.20.0-single-reviewer-reconciliation`. P2O4-T11 establishes current cross-program catalog availability while deferring product fitness, but its 0.21.0 release tag is not a verified repository baseline; issue #417 must first prove checkout-stable evidence bytes in 0.21.1. Six burned candidate units survive, 0 background units survive, 50 units remain ignored, and Tepee contributes no accepted candidate. The reveal is open and the preflight sequence exception is disclosed. Issue #393 is closed as superseded, not satisfied. Never claim reviewer two, inter-rater agreement, consensus, adjudication, ground truth, or validation. Issue #416 owns exact current bundle acquisition and scientific-fitness review after remediation. No accepted dataset, split, baseline, model, deployed analytical application, or independent scientific fitness decision exists.
