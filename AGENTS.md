...
P2O4-T01 through P2O4-T18 ship verified proposal, source, review, custody, remediation, six-candidate, and exact owner-review-surface evidence through `v0.30.0-region-owner-review-surface`. Historical 6/0/50 exclusions are not inherited. P2O4-T19 / issue #461 preserves the exact completed six-region response and accepts three burned plus three background regions only after every response, raster, source/terms, quality, uncertainty-ring, and event-leakage gate passes. The resulting `owner-approved-prototype-region-labels-v0.1.0` is prototype evidence, not independent ground truth. Three event groups remain below the required six; no accepted dataset, split, baseline, model, deployed analytical application, or independent scientific fitness decision exists. Never claim reviewer two, inter-rater agreement, consensus, field validation, official status, endorsement, or operational readiness.
