...
P2O2-T04 preserves active-fire reference semantics under `weak-reference-label-feasibility-v0.1.0`. P2O2-T06 preserves burned, background-candidate, unknown, excluded, and review-needed under `burn-scar-label-protocol-v0.1.0`. Do not coerce 375 m points, non-detections, buffers, dNBR/SCL, or the later NIFC perimeter into 10-20 m labels. Unknown, excluded, and review-needed pixels never become background silently. Before label construction, require local content-registration residual at or below 0.5 native 20 m pixel or remediate/exclude, then perform independent second-pass QA. No dataset, split, baseline, or model may be created before that label gate passes.
