...
P2O3-T01 is shipped at verified `v0.8.0-content-registration-baseline`. Issue #347 / PR #348 analytically accepted all twelve local-registration windows at merge `c01cdb12033e7a9440ad0502b92a8887fd79ed1d` without creating labels. The first merged-main reconstruction correctly withheld the tag after Windows checkout exposed CRLF JSON/HTML against the declared LF contract. Issue #349 / PR #350 added the explicit checkout rule without changing measurements or decisions; remediation merge `1297471be45200c40f9f40746e85b437ce6e0c0d` passed the fresh merged-main release gate and is the target of annotated tag object `14edfad3ce89dbd9179a54eb1e29811e41d258c0`. The active next checkpoint is a reviewable five-state label proposal with independent QA.
...
- `CONTENT-REGISTRATION-2026-001` re-verifies that pair and measures independent B04/B8A/B12 gradient translation in twelve fixed windows. All pass; median residual is 0.0224 pixel and maximum is 0.0361 pixel / about 0.72 m. Product QC remains context, window passes never override SCL states, and label implementation remains false.
...
P2O2-T04 preserves active-fire reference semantics under `weak-reference-label-feasibility-v0.1.0`. P2O2-T06 preserves burned, background-candidate, unknown, excluded, and review-needed under `burn-scar-label-protocol-v0.1.0`. P2O3-T01 satisfies the bounded local-translation prerequisite under `local-content-registration-v0.1.0`; it does not satisfy label review. Do not coerce 375 m points, non-detections, buffers, dNBR/SCL, product QC, registration windows, or the later NIFC perimeter into 10-20 m labels. Unknown, excluded, and review-needed pixels never become background silently. A label proposal still requires independent second-pass QA, disagreement recording, boundary review, and a five-state audit sample. No dataset, split, baseline, or model may be created before that label gate passes.
