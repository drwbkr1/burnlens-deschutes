...
P2O4-T01 through P2O4-T04 ship verified one-event and cross-event five-state proposal evidence, source fitness, all-pixel software QA, and topology-stable provenance through `v0.12.1-topology-stable-label-transfer`. P2O4-T05 / issue #375 / PR #376 ships verified `v0.13.0-label-review-readiness`. P2O4-T06 / issue #379 / PR #380 ships verified `v0.14.0-offline-reviewer-handoff`. P2O4-T07 / issue #383 / PR #385 ships verified `v0.15.0-live-browser-reviewer-handoff`. P2O4-T08 ships verified `v0.16.0-first-reviewer-response-lock` through issue #384 / PR #388 and issue #389 / PR #390: one actual returned response and its private receipt are exact, ignored, and operator-locked; bounded public JSON/HTML/PNG exposes only hashes, completeness, packet binding, chronology, content withholding, and the one-of-two state. P2O4-T09A / issue #394 / PR #395 ships verified `v0.17.0-dual-lock-custody-readiness`: the exact legacy first lock and a current-protocol software fixture pass an independent two-pair verifier without representing the fixture as human evidence. P2O4-T09B / issue #402 / PR #404 ships verified `v0.18.0-atomic-response-intake-readiness`: one production command atomically preserves and receipts a response in ignored storage, and fixture-only public QA proves the path without adding human evidence or opening the reveal. On 2026-07-16 the owner explicitly waived the planned second-human-response gate. Issue #393 is closed as superseded, not satisfied; issue #403 controls a reduced-validation single-reviewer reveal and reconciliation path. Never claim reviewer two, inter-rater agreement, consensus, or adjudication. The reveal remains operator-declared unopened. No accepted label set, dataset, split, baseline, model, deployed analytical application, or independent scientific fitness decision exists.
