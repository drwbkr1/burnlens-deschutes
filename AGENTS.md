...
P2O4-T01 / issue #353 / PR #354 is shipped at verified `v0.9.0-label-proposal-baseline`: BurnLens `0.9.0` implements a native-grid five-state proposal and separate all-pixel software QA. P2O4-T02 / issue #357 / PR #358 is shipped at verified `v0.10.0-cross-event-feasibility-baseline`: Tepee/McKay pairs and whole groups are frozen. P2O4-T03 ships through issue #361 / PR #362 and trace-remediation issue #363 / PR #364 at verified `v0.11.0-cross-event-source-fitness-baseline`: four exact archives are registered; McKay passes; Tepee retains visible SCL/window exclusions; protocol/schema trace is explicit. P2O4-T04 / issue #367 is the verified BurnLens `0.12.0` candidate: two exact MTBS clips support five-state Tepee/McKay proposals, and separate QA reproduces all 63,930 pixels with zero mismatch. An accepted dataset, split, baseline, model, and independent human review still do not exist.
