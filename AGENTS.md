...
P2O4-T01 through P2O4-T04 ship verified one-event and cross-event five-state proposal evidence, source fitness, all-pixel software QA, and topology-stable provenance through `v0.12.1-topology-stable-label-transfer`. P2O4-T05 through P2O4-T10B ship verified review, handoff, custody, atomic-intake, owner-waiver readiness, and historical reduced-validation reconciliation through `v0.20.0-single-reviewer-reconciliation`. P2O4-T11 through P2O4-T16 ship current-source evidence, the 56-unit owner-confirmed workflow, 24 sparse owner-approved prototype center labels, a fail-closed sufficiency decision, and the verified region/event remediation contract through `v0.28.0-label-region-remediation-plan`. Historical 6/0/50 exclusions are not inherited. P2O4-T17 / issue #453 has a locally verified no-promotion release candidate with six intact regions and zero region decisions or labels; release lifecycle remains pending. Never claim reviewer two, independent ground truth, inter-rater agreement, consensus, field validation, official status, endorsement, or operational readiness. No region label, accepted dataset, split, baseline, model, deployed analytical application, or independent scientific fitness decision exists.
