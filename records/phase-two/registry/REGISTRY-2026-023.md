...
| `CROSS-EVENT-REFERENCE-INVENTORY-2026-001` JSON/HTML/PNG | Current catalog availability and freshness evidence | Run `BL-2026-07-17-current-reference-inventory-r001` | 0 |
...
| Clean-checkout tests and packaging | Tests, compilation, dependencies, wheel, isolated install, privacy | 188 tests; identical 348,031-byte wheels; 0.21.0 / 34 entry points | 0 |
| `MANIFEST-2026-023.json` | Exact three-output inventory and candidate gates | Candidate; PR/merge/tag/fresh-main pending | 0 |
