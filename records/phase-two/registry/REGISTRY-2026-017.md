...
| `MANIFEST-2026-017.json` | Exact five-output inventory and release quality gates | Shipped; PR #385, fresh merged-main clone, canonical wheel, exact reconstruction, fresh browser run, and remote-tag gates pass; lifecycle sync issue #386 / PR #387 | 0 |
