...
| `MANIFEST-2026-016.json` | Exact seven-output inventory, local archive identity, and release gates | Shipped; PR #380, fresh merged-main, canonical-wheel, exact reconstruction, and remote-tag gates pass; lifecycle sync issue #381 | 0 |
