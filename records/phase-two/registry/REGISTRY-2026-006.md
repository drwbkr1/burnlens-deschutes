...
**Checkpoint:** Issue #329 / draft PR #330; candidate `v0.4.0-authenticated-source-baseline`
...
| `MANIFEST-2026-006.json` | Candidate provenance manifest | Issue #329 / PR #330; exact merge/tag identity pending shipment sync | 0 |
