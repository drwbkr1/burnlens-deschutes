...
| `P2O5-T03-U07-SYNC-R001` | issue #564 / PR #565; current repository truth only | claims, links, JSON, LF, focused regression, live PR, post-merge main | `candidate-pass` | merge and fresh main |
