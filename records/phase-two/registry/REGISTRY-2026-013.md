...
|---|---|---|---:|
| `burnlens/mtbs_cross_event_reference.py` and acquisition CLI | Exact public annual-MTBS clip contract, bounded download, registration, OneDrive-aware immutable-byte verification | `burnlens-mtbs-cross-event-reference-v0.1.0`; run `BL-2026-07-16-mtbs-cross-event-reference-r003` | 0 |
| `burnlens/cross_event_label_transfer.py` and proposal CLI | Five-state Tepee/McKay proposal, binary targets, JSON/HTML/PNG, GeoTIFF trace | `cross-event-five-state-transfer-v0.1.0`; run `BL-2026-07-16-cross-event-label-transfer-r003` | 0 |
| `burnlens/cross_event_label_transfer_qa.py` and QA CLI | Separately invoked all-source/all-pixel recomputation and deterministic state audit | `separate-cross-event-five-state-qa-v0.1.0`; run `BL-2026-07-16-cross-event-label-transfer-qa-r003` | 0 |
