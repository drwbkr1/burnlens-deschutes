...
| `MANIFEST-2026-014.json` | Exact corrected ten-output inventory and release gates | Shipped; PR #372, fresh merged-main, canonical-wheel, real-reconstruction, and remote-tag gates pass; sync #373 | 0 |
