...
| P2O5-T01-REM | `records/prompt-build-log/2026-07-18-p2o5-t01-rem.md` | issue #446; checkout-stability remediation | Records the failed first fresh-main byte gate, pins readiness JSON/HTML to LF, and repeats detached-checkout test, package, and exact-output gates without changing scientific state. |
