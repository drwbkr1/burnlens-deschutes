...
| P2O3-T01 | `records/prompt-build-log/2026-07-15-p2o3-t01.md` | issue #347 / PR #348; analytically merged, tag withheld | Exact pair-local content registration accepted across twelve fixed AOI windows; post-merge LF reconstruction defect routed to #349. |
| P2O3-T01-REM | `records/prompt-build-log/2026-07-15-p2o3-t01-rem.md` | issue #349; review-ready | Explicit LF checkout contract; fresh clone reconstructs JSON/HTML/PNG byte for byte; no analytical change. |
