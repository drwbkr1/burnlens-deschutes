...
| P2O4-T03 | `records/prompt-build-log/2026-07-15-p2o4-t03.md` | issue #361; candidate source-fitness checkpoint | Four exact Tepee/McKay archives registered; McKay passes and Tepee is accepted with visible SCL/window exclusions; no labels or dataset; PR/merge/tag pending. |
