...
| P2O4-T20 | `records/prompt-build-log/2026-07-19-p2o4-t20.md` | issue #466 / PR #469 plus release-metadata remediation #470; BurnLens 0.32.0 release candidate | Freezes Green Ridge, Grandview, and Petes Lake as metadata-only acquisition groups, reaches six event identities and repeated source regimes, downloads zero provider bytes, and withholds the tag until the canonical fresh-clone package binding is merged and reverified. |
