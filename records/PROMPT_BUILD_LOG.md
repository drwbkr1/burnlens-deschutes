...
| P2O4-T08 | `records/prompt-build-log/2026-07-16-p2o4-t08.md` | issue #384 / PR #388; merged at `836eef75495dbc671bd74a8ad4112852bbf50ac6` | Preserves one exact returned response and private receipt in ignored storage, publishes content-withheld hash-lock evidence, and keeps the one-of-two/no-reveal/no-dataset gates binding. Tag withheld for issue #389 chronology remediation. |
| P2O4-T08-REM | `records/prompt-build-log/2026-07-16-p2o4-t08-rem.md` | issue #389 / PR #390; release remediation active | Corrects only the candidate-manifest creation time, binds exact PR #388 lifecycle, repeats fresh-main gates, and completes the v0.16.0 tag without changing evidence bytes or scientific state. |
...
The controlling execution goal and six-phase roadmap are merged and tagged at `v0.0.8-execution-goal-baseline`. Phase Two is active. P2O4-T07 ships at verified `v0.15.0-live-browser-reviewer-handoff`. Reviewable Darlene/Tepee/McKay proposal evidence, a proposal-blinded 56-unit instrument, an isolated offline workbench, independent handoff QA, and one exact current-Chrome software acceptance run exist. The browser fixture is not human evidence. P2O4-T08 / issue #384 / PR #388 merged BurnLens `0.16.0` public-lock evidence for one exact private returned response and receipt. Issue #389 corrects only manifest chronology and completes release gates before tag. Review content remains withheld, the reveal remains operator-declared unopened, and a second response is required. No adjudication, independently accepted labels, dataset, split, baseline, or model exists. Authorized credentials are used without retaining secrets; exact raw packages and private response bytes remain local/ignored. Historical Objective Seven restrictions that conflict with the controlling goal are retained only as audit evidence and do not govern current execution.
