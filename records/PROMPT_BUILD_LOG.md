...
| P2O2-T05 | `records/prompt-build-log/2026-07-14-p2o2-t05.md` | issue #337 / PR #338; active review candidate | Owner-approved `target-burn-scar-v0.2.0`; current MTBS no-Darlene/AOI evidence; deterministic target-decision artifact; no label, dataset, baseline, or model. |
