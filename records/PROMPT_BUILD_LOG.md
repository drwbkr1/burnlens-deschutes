...
| P2O4-T08-REM | `records/prompt-build-log/2026-07-16-p2o4-t08-rem.md` | issue #389; release remediation active | Corrects only the candidate-manifest creation time, binds exact PR #388 lifecycle, repeats fresh-main gates, and completes the v0.16.0 tag without changing evidence bytes or scientific state. |
