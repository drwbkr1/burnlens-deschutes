...
| P2O4-T28-SYNC | `records/prompt-build-log/2026-07-20-p2o4-t28-sync.md` | issue #505; verified v0.40 lifecycle synchronization | Records PR #504, merge, fresh-main reconstruction, canonical package, remote annotated tag, and next issue #503 without changing scientific or private state. |
