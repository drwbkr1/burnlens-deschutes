...
| P2O4-T11 | `records/prompt-build-log/2026-07-17-p2o4-t11.md` | issue #411; BurnLens `0.21.0` candidate; source `8d58178cc0f43b801a6fbab422d69a509716327b`; evidence `e888e4dc6e772921c417768d6f4b05858af9af69` | Confirms seven exact current BAER/RAVG/MTBS catalog identities across all three events, records official archive modernization, preserves legacy proposal provenance, and defers labels/dataset/model until exact current bundle fitness passes. |
