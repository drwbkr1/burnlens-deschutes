...
| P2O4-T19 | `records/prompt-build-log/2026-07-19-p2o4-t19.md` | issue #461; BurnLens 0.31.0 release candidate | Preserves the exact completed region response, accepts six owner-approved prototype regions after all gates pass, and keeps dataset/split/baseline/model work blocked at three event groups. |
