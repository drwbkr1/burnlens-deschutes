...
| P2O4-T20 | `records/prompt-build-log/2026-07-19-p2o4-t20.md` | issue #466 / `codex/p2o4-t20-additional-event-groups`; BurnLens 0.32.0 release candidate | Freezes Green Ridge, Grandview, and Petes Lake as metadata-only acquisition groups, reaches six event identities and repeated source regimes, and downloads zero provider bytes. Exact source/pixel fitness remains next. |
