...
| P2O4-T25 | `records/prompt-build-log/2026-07-20-p2o4-t25.md` | issue #487 / PR #492; release-ready BurnLens 0.37.0; next #491 | Binds both exact Green Ridge proposals to a blank owner review surface. Exact reconstruction, static evidence, tests, packaging, and the owner-operated rendered completion/export path pass; exact response custody and reconciliation remain #491. |
