...
| BL-GOV-002 | `records/prompt-build-log/2026-07-16-bl-gov-002.md` | issue #400 / draft PR #401; source `845125070d5e4c3c4132bae027a786e1cc25bc9c`; obsolete state closed; merge review pending | Re-runs the current user-facing and custody paths, records complete live tag/release state, closes obsolete Phase One GitHub work while preserving its evidence, and keeps issue #393 as the active scientific checkpoint without changing analytical or private state. |
