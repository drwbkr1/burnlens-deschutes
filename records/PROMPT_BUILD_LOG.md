...
| P2O4-T19-REM | `records/prompt-build-log/2026-07-19-p2o4-t19-rem.md` | issue #464; checkout-stability remediation | Records the fresh-main JSON byte failure and adds explicit per-record EOL contracts without changing scientific state. |
