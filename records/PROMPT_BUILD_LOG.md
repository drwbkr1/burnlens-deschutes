...
| P2O2-T05 | `records/prompt-build-log/2026-07-14-p2o2-t05.md` | issue #337 / PR #338; merged at `68971e9709b886adf8575a58d32694aad42f038e` | Owner-approved `target-burn-scar-v0.2.0`; current MTBS no-Darlene/AOI evidence; no label, dataset, baseline, or model. Post-merge reconstruction withheld the tag. |
| P2O2-T05-REM | `records/prompt-build-log/2026-07-14-p2o2-t05-rem.md` | issue #339 / PR #340; active review candidate | Preserve `r001`; normalize structured-input hashes and target serialization; publish immutable corrected `r002`; require post-merge reconstruction before the `0.6.0` tag. |
