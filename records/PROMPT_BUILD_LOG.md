...
| P2O2-T05-REM | `records/prompt-build-log/2026-07-14-p2o2-t05-rem.md` | issue #339; active remediation branch | Preserve `r001`; normalize structured-input hashes and target serialization; publish immutable corrected `r002`; require post-merge reconstruction before the `0.6.0` tag. |
