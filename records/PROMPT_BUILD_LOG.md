...
| P2O4-T09A | `records/prompt-build-log/2026-07-16-p2o4-t09a.md` | issue #394; candidate `v0.17.0-dual-lock-custody-readiness` | Preserves the exact legacy first response/receipt pair, adds current receipt identity plus an independent two-pair verifier, and proves mixed-version custody with one real returned-response origin plus one explicitly non-human software fixture. A second human response, reveal, comparison, adjudication, and dataset work remain absent. |
