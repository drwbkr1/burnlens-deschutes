...
| P2O2-T06 | `records/prompt-build-log/2026-07-15-p2o2-t06.md` | issue #343; active exact optical-pair checkpoint | Acquire and visually validate one same-orbit Sentinel-2 pre/post pair and version a five-state burn-scar label protocol without creating label pixels, a dataset, baseline, or model. |
