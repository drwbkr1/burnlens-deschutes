...
| P2O4-T02 | `records/prompt-build-log/2026-07-15-p2o4-t02.md` | issue #357 / working branch | Current MTBS/Census/CDSE metadata selects exact Tepee/McKay acquisition pairs and freezes whole leakage groups; no imagery, dataset, split, baseline, or model. PR/merge/tag pending. |
