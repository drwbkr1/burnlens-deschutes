...
| P2O2-T06 | `records/prompt-build-log/2026-07-15-p2o2-t06.md` | issue #343; review-ready optical-pair candidate | Exact same-orbit Sentinel-2 pair registered and visually validated; five-state protocol versioned without creating label pixels, a dataset, baseline, or model. PR, merged-main reconstruction, and tag remain pending. |
