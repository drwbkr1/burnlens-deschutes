...
| P2O2-T06 | `records/prompt-build-log/2026-07-15-p2o2-t06.md` | issue #343 / PR #344; review-ready optical-pair candidate | Exact same-orbit Sentinel-2 pair registered and visually validated; five-state protocol versioned without creating label pixels, a dataset, baseline, or model. Merge, merged-main reconstruction, and tag remain pending. |
...
The controlling execution goal and six-phase roadmap are merged and tagged at `v0.0.8-execution-goal-baseline`. Phase Two is active. P2O2-T05 is shipped at `v0.6.0-burn-scar-target-baseline`; lifecycle issue #341 / PR #342 merged at `f3d528772ac1e0655fe29eda60c95518dc422603`. P2O2-T06 / issue #343 / PR #344 is a review-ready exact optical-pair and label-protocol candidate; merge, merged-main reconstruction, and tag remain pending. No label, dataset, baseline, or model exists. Authorized credentials are used without retaining secrets; exact raw packages remain local/ignored. Historical Objective Seven restrictions that conflict with the controlling goal are retained only as audit evidence and do not govern current execution.
