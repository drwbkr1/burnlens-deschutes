...
| P2O4-T14 | `records/prompt-build-log/2026-07-17-p2o4-t14.md` | issue #432 / draft PR #434; BurnLens 0.25.0 candidate | Reopens all 56 original units with disclosed optical/current-reference evidence, blank yes/no/uncertain responses, hash-named export/reload/lock custody, and zero labels. Thirty-two nonbinary origins remain quality-blocked; automated QA remains non-human fixture evidence. |
