...
| P2O4-T08 | `records/prompt-build-log/2026-07-16-p2o4-t08.md` | issue #384; BurnLens `0.16.0` candidate | Preserves one exact returned response and private receipt in ignored storage, publishes content-withheld hash-lock evidence, and keeps the one-of-two/no-reveal/no-dataset gates binding. PR, merge, tag, and fresh-main verification remain pending. |
