...
| P2O4-T23 | `records/prompt-build-log/2026-07-20-p2o4-t23.md` | issue #480; BurnLens 0.35.0 release candidate; next #483 | Acquires one exact near-anniversary Sentinel scene, passes registration, and opens a conjunctive Green Ridge background-evidence route while creating zero candidates, owner responses, labels, dataset, split, baseline, or model. |
