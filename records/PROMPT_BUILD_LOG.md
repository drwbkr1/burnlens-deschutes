...
| P2O4-T16 | `records/prompt-build-log/2026-07-18-p2o4-t16.md` | issue #449; BurnLens 0.28.0 candidate | Defines region-first owner review, explicit unknown rings, six-event/source-regime advancement gates, and metadata-first acquisition priorities without creating labels or analytical versions. |
