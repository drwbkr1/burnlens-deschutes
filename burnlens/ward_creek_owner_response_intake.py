...
:root{{color-scheme:dark}}*{{box-sizing:border-box}}body{{margin:0;background:#07110f;color:#eef7f3;font:17px/1.55 system-ui,sans-serif}}header{{padding:2rem max(1rem,calc((100vw - 1040px)/2));background:#0e1d1a;border-bottom:1px solid #315b50}}header p{{color:#b9d8cf}}h1{{max-width:850px;font-size:clamp(2rem,5vw,4rem);line-height:1.05}}main{{max-width:1040px;margin:auto;padding:1rem}}.warning,.card{{padding:1.1rem;border:1px solid #315b50;border-radius:14px;background:#0e1d1a}}.warning{{border-color:#a06b28;color:#ffca73}}.metrics{{display:grid;grid-template-columns:repeat(4,1fr);gap:.8rem;margin:1rem 0}}.metric{{padding:1rem;background:#eef7f3;color:#07110f;border-radius:12px}}.metric strong{{display:block;color:#006b64;font-size:2rem}}img{{display:block;width:100%;height:auto;border:1px solid #315b50}}code{{word-break:break-word}}li+li{{margin-top:.45rem}}@media(max-width:700px){{.metrics{{grid-template-columns:1fr 1fr}}header{{padding:1.4rem 1rem}}main{{padding:.65rem}}}}
