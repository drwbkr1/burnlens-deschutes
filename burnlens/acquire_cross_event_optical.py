"""Acquire and register the four exact owner-authorized cross-event products."""
...
def main() -> int:
    ...
    try:
        ...
        metadata = refresh_cross_event_metadata(observed_at_utc=args.generated_at_utc)
        ...
        write_private_state(
            args.state_file,
            {
                "decision": "CROSS_EVENT_ACQUISITION_FAILED",
