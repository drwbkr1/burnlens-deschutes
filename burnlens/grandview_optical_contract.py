"""Exact fail-closed acquisition contract for the Grandview Sentinel pair."""
...
TERMS_REVIEW_ID = "TERMS-2026-020"
...
GRANDVIEW_CONTRACTS = (
    _contract(
        role="grandview-2021-pre",
        provider_id="09ac9f82-cbf8-4e30-a24a-36f719678e95",
        safe_name="S2B_MSIL2A_20210603T184919_N0500_R113_T10TFQ_20230130T001253.SAFE",
        size_bytes=954_915_511,
        md5="128033615ac0bbacdb01c90440fa31cf",
        blake3="1bfc2618bc9fa27b5c9425697b8b93b749d3f624397bc0fc60f631fa7a6ea458",
    ),
    _contract(
        role="grandview-2021-post",
        provider_id="c627f11b-37a9-44b4-b481-1f34af3a6304",
        safe_name="S2B_MSIL2A_20210723T184919_N0500_R113_T10TFQ_20230131T130926.SAFE",
        size_bytes=968_566_283,
        md5="6cb18ff38e0e7b0f7375145651e0938e",
        blake3="ae5a557545eb28cf199bba8457d6cffd770c25ca67230e27c0bea00ace326fd8",
    ),
)
...
EXPECTED_METADATA = {
    "grandview-2021-pre": {
        "acquisition_utc": "2021-06-03T18:49:19.024000Z",
        "platform_serial_identifier": "B",
        "tile_id": "10TFQ",
        "relative_orbit_number": 113,
        "processor_version": "05.00",
        "product_type": "S2MSI2A",
        "cloud_cover_percent": 0.000148,
    },
    "grandview-2021-post": {
        "acquisition_utc": "2021-07-23T18:49:19.024000Z",
        "platform_serial_identifier": "B",
        "tile_id": "10TFQ",
        "relative_orbit_number": 113,
        "processor_version": "05.00",
        "product_type": "S2MSI2A",
        "cloud_cover_percent": 0.000379,
    },
}
...
def validate_grandview_contracts(contracts: Iterable[AssetContract]) -> list[str]:
    ...
    if {item.role for item in items} != set(EXPECTED_METADATA):
        return [*reasons, "GRANDVIEW_ROLE_SET_MISMATCH"]
    ...
    if identities != {("S2B", "0500", "113", "10TFQ")}:
        reasons.append("GRANDVIEW_PAIR_GEOMETRY_IDENTITY_MISMATCH")
    return reasons
...
def validate_grandview_metadata(
    snapshot: dict[str, Any], contracts: Iterable[AssetContract] = GRANDVIEW_CONTRACTS
) -> list[str]:
...
def refresh_grandview_metadata(
    *, observed_at_utc: str, urlopen_fn: Callable[..., Any] = urlopen
) -> dict[str, Any]:
    headers = {"Accept": "application/json", "User-Agent": USER_AGENT}
    records = []
    for contract in GRANDVIEW_CONTRACTS:
    ...
    reasons = validate_grandview_metadata(snapshot)
    if reasons:
...
def acquire_grandview_package(
    *,
    ...
    reasons = validate_grandview_contracts(GRANDVIEW_CONTRACTS)
    reasons.extend(validate_grandview_metadata(metadata_snapshot))
    if reasons:
        raise AcquisitionError("GRANDVIEW_PACKAGE_CONTRACT_REJECTED", detail=",".join(reasons))
    ...
    if destination.exists():
        ...
        return {
            "decision": "REUSED_VERIFIED_REGISTERED_GRANDVIEW_PACKAGE",
    ...
    try:
        ...
        evaluation = evaluate_quarantine(
            quarantine, GRANDVIEW_CONTRACTS, contract_validator=validate_grandview_contracts
        )
    ...
    return {
        "decision": "REGISTERED_EXACT_GRANDVIEW_PACKAGE",
