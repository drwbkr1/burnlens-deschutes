...
<style>*{{box-sizing:border-box}}body{{margin:0;background:#f3efe5;color:#123f3a;font:16px/1.5 Arial,sans-serif;overflow-wrap:anywhere}}header,main{{width:100%;max-width:1180px;margin:auto;padding:28px}}header{{background:#123f3a;color:white;max-width:none}}header div{{max-width:1180px;margin:auto}}.warning{{background:#fff4d2;border-left:6px solid #f05a28;padding:16px}}.hero{{display:block;width:100%;height:auto;border:1px solid #b6c5bd}}.metrics{{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}}.metric,.card{{min-width:0;background:white;border:1px solid #c7d2cc;border-radius:10px;padding:16px}}.metric strong{{display:block;font-size:1.7rem}}.table{{width:100%;max-width:100%;overflow-x:auto}}table{{border-collapse:collapse;width:100%;min-width:560px;background:white}}th,td{{padding:10px;border:1px solid #c7d2cc;text-align:left}}code{{overflow-wrap:anywhere;word-break:break-word}}@media(max-width:700px){{.metrics{{grid-template-columns:1fr 1fr}}header,main{{padding:18px}}}}</style></head>
