"""Build the blank Green Ridge owner review surface."""
...
from .green_ridge_owner_review_surface import (
    GreenRidgeOwnerReviewSurfaceError,
    build_surface,
    write_surface,
)
...
def main() -> int:
    ...
    try:
        ...
        print("labels=0")
        return 0
    except (GreenRidgeOwnerReviewSurfaceError, OSError, ValueError, KeyError, TypeError) as error:
        print(f"GREEN_RIDGE_OWNER_REVIEW_SURFACE_FAILED: {error}", file=sys.stderr)
        return 2
