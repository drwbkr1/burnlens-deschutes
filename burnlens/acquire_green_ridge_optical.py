"""Acquire and register the exact owner-authorized Green Ridge Sentinel pair."""
...
def main() -> int:
    ...
    try:
        ...
        metadata = refresh_green_ridge_metadata(observed_at_utc=args.generated_at_utc)
        result = acquire_green_ridge_package(
        ...
        write_private_state(
            args.state_file,
            {
                "decision": "GREEN_RIDGE_ACQUISITION_FAILED",
