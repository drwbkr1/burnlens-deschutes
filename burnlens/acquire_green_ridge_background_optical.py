"""Acquire the exact owner-authorized Green Ridge extended optical scene."""
...
from .green_ridge_background_optical_contract import (
    CdseCredentials,
    acquire_background_optical_package,
...
def main() -> int:
    ...
    try:
        ...
        metadata = refresh_background_optical_metadata(observed_at_utc=args.generated_at_utc)
        result = acquire_background_optical_package(
        ...
        write_private_state(
            args.state_file,
            {
                "decision": "BACKGROUND_OPTICAL_ACQUISITION_FAILED",
