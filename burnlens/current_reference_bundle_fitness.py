    ...
    *,
            ...
            with rasterio.open(proposal_path) as proposal_ds:
                ...
                if event.mtbs_token:
                    mtbs_record, mtbs_sampled, mtbs_categories = _categorical_product(
                        ...
                        affirmative_values=(2, 3, 4), ambiguous_values=(1, 5), invalid_values=(0, 6),
                    )
    ...
    report = {
        ...
        "method": {
            ...
            "mtbs_affirmative": "dNBR6 classes 2-4; classes 1/5 ambiguous; 0/6 outside, mask, or nonprocessing.",
