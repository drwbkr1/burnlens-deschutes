"""Build the no-promotion Grandview region proposal."""
...
from .grandview_region_proposal import GrandviewRegionProposalError, build_report, write_outputs
...
def main() -> int:
    ...
    try:
        ...
        return 0
    except (GrandviewRegionProposalError, OSError, ValueError, KeyError) as error:
        print(f"GRANDVIEW_REGION_PROPOSAL_FAILED: {error}", file=sys.stderr)
        return 2
